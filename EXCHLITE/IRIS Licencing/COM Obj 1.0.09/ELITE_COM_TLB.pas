...
// File generated on 21/04/2006 14:30:52 from Type Library described below.
...
// *********************************************************************//
  IEliteCom = dispinterface
    ...
    function SaveSQLServerNameForLocalDB(const SQLServerName: WideString; 
                                         const DBLocation: WideString): WordBool; dispid 1610743812;
    function DecodeCDKey(const CDKey: WideString): WideString; dispid 1610743813;
    function GetLicenceCodes(const CDKey: WideString): WideString; dispid 1610743814;
    function DecodeLicenceCode(const CDKeyText: WideString; const LicenceCodeText: WideString): WideString; dispid 1610743815;
    function ClearLicenceLimits: WordBool; dispid 1610743816;
    function AddLicenceLimit(RestrictionID: Integer; LimitID: Integer; const LimitValue: WideString): WordBool; dispid 1610743817;
    function ValidateLicence(const CDKeyText: WideString; const LicenceCode: WideString): WordBool; dispid 1610743818;
    function LicenceLimitsCount: Integer; dispid 1610743819;
    function ActivateFromWS(const CDKey: WideString; CheckStatus: WordBool; const Until_: WideString): WideString; dispid 1610743820;
    function ActivateCDKey(const CDKey: WideString; const ActivationCode: WideString): WideString; dispid 1610743821;
    function InitialiseLocalDatabase: WordBool; dispid 1610743822;
    function GetLicenceRestrictionsWS(const CDKey: WideString; const LicenceCode: WideString): WideString; dispid 1610743823;
  end;
