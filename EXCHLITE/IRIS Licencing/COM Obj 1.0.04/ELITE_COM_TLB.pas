...
// File generated on 14/03/2006 16:07:30 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Program Files\IRIS Software Ltd\Network MSI\Iris Account Office Licensing COM.tlb (1)
...
// *********************************************************************//
  IEliteCom = dispinterface
    ...
    function SaveSQLServerName(const SQLServerName: WideString): WordBool; dispid 1610743810;
    function SaveSQLServerNameForLocalDB(const SQLServerName: WideString; 
                                         const DBLocation: WideString): WordBool; dispid 1610743811;
    function DecodeCDKey(const CDKey: WideString): WideString; dispid 1610743812;
    function GetLicenceCodes(const CDKey: WideString): WideString; dispid 1610743813;
    function DecodeLicenceCode(const CDKeyText: WideString; const LicenceCodeText: WideString): WideString; dispid 1610743814;
    function ClearLicenceLimits: WordBool; dispid 1610743815;
    function AddLicenceLimit(RestrictionID: Integer; LimitID: Integer; const LimitValue: WideString): WordBool; dispid 1610743816;
    function ValidateLicence(const CDKeyText: WideString; const LicenceCode: WideString): WordBool; dispid 1610743817;
    function LicenceLimitsCount: Integer; dispid 1610743818;
    function ActivateFromWS(const CDKey: WideString; CheckStatus: WordBool; const Until_: WideString): WideString; dispid 1610743819;
    function ActivateCDKey(const CDKey: WideString; const ActivationCode: WideString): WideString; dispid 1610743820;
    function InitialiseLocalDatabase: WordBool; dispid 1610743821;
    function GetLicenceRestrictionsWS(const CDKey: WideString; const LicenceCode: WideString): WideString; dispid 1610743822;
  end;
