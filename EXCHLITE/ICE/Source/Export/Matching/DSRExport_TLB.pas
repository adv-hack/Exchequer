...
// ************************************************************************  //
// Type Lib: C:\ICE\dsrexport.dll (1)
...
// Parent TypeLibrary:
//   (0) v1.0 IrisClientSync, (X:\EXCHLITE\ICE\Source\Export\Matching\ICSExMat.tlb)
// ************************************************************************ //
...
// *********************************************************************//
  IExportBox = interface(IDispatch)
    ...
    function DoExport(const pDataPath: WideString; const pXMLPath: WideString; 
                      const pParam1: WideString; const pParam2: WideString; pUserReference: LongWord): LongWord; safecall;
...
// *********************************************************************//
  IExportBoxDisp = dispinterface
    ['{B8588DFD-DC3E-4B45-AC8C-A09EAF79FB6D}']
    function DoExport(const pDataPath: WideString; const pXMLPath: WideString; 
                      const pParam1: WideString; const pParam2: WideString; pUserReference: LongWord): LongWord; dispid 1;
