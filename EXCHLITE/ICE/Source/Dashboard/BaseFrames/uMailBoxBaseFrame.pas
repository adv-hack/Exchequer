...
//    fCompanyActive: Boolean;
  ...
  Published
    ...
    property AskPassword: Boolean read fAskPassword write fAskPassword default False;
    property ValidPassword: Boolean read fValidPassword write fValidPassword default False;   
  End;
