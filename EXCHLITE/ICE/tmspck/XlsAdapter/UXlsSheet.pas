...
type
  ...
  private
    ...
    procedure LoadSubChart(const DataStream: TStream; const SST: TSST);
  protected
...
procedure TFlxChart.LoadSubChart(const DataStream: TStream; const SST: TSST);
var
...
begin
  repeat
    ...
    try
      ...
      if (R is TBofRecord) then begin; FChartRecords.Add(R); LoadSubChart(DataStream, SST); end
