...
uses
  Dialogs, Forms, Windows, SysUtils, Classes, Graphics, Menus, ImgList, Controls, AdvGDIP
  {$IFDEF TMSDOTNET}
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            gsolidbrush := TGPSolidBrush.Create(ColorToARGB(AdvMenu.CurrentMenuStyler.SelectedItem.NotesFont.Color));
          end
          else
          begin
            ...
            gsolidbrush := TGPSolidBrush.Create(ColorToARGB(AdvMenu.CurrentMenuStyler.NotesFont.Color));
          end;
