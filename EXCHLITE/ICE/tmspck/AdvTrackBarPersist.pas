    ...
    try
      ...
      begin
        ...
        begin
          case PropList^[I - 1].PropType^.Kind of
          tkFloat:
             AIniFile.WriteString(BasePropName + TypeInfo.Name ,PropName,Format('%g',[GetFloatProp(AObject,PropList^[I - 1])]));

          tkInteger,
          tkWChar,
          tkChar:
             AIniFile.WriteInteger(BasePropName + TypeInfo.Name,PropName,GetOrdProp(AObject,PropList^[I - 1]));

          tkString,
          tkLString,
          tkWString:
             AIniFile.WriteString(BasePropName + TypeInfo.Name,PropName,GetStrProp(AObject, PropList^[I - 1]));

          tkEnumeration:
            begin
              TypeData := GetTypeData(PropList^[I - 1].PropType^);
              AIniFile.WriteString(BasePropName + TypeInfo.Name,PropName,GetEnumName(TypeData.BaseType^, GetOrdProp(AObject,PropList^[I - 1].Name)));
            end;

          tkSet:
            AIniFile.WriteString(BasePropName + TypeInfo.Name,PropName,GetSetPropModified(AObject,PropList^[I - 1]));
          end;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          tkFloat:
            begin
              s := AINIFile.ReadString(TypeInfo.Name, PropName,'0');
          ...
          tkChar,
          tkWChar:
             SetOrdProp(AObject, PropList^[I - 1], AINIFile.ReadInteger(TypeInfo.Name, PropName,0) );

          tkString,
          tkLString,
          tkWString:
            SetStrProp(AObject, PropList^[I - 1], AINIFile.ReadString(TypeInfo.Name,PropName,''));

          tkEnumeration: SetEnumProp(AObject, PropList^[I - 1],AINIFile.ReadString(TypeInfo.Name,PropName,''));

          tkSet:         SetSetProp(AObject, PropList^[I - 1],AINIFile.ReadString(TypeInfo.Name,PropName,''));
