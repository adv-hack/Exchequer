...
begin
  ...
  {  if Enabled or (DisabledImages = nil) then
    ...
    begin
      ...
      TxtR := DrawVistaText(Canvas, AAlign, CapR, DCaption, Canvas.Font, AdvPages[PageIndex].Enabled, True, FAntiAlias, tpTop, Ellipsis);
    end
    else
    if (TabPosition = tpLeft) then
    begin
...
{$ENDIF}
    ...
    begin
      ...
      TxtR := DrawVistaText(Canvas, AAlign, CapR, DCaption, Canvas.Font, AdvPages[PageIndex].Enabled, True, FAntiAlias, TabPosition, Ellipsis);
...
begin
  FNextPictureChanged := (Sender = FScrollButtonNextPicture);
  FPrevPictureChanged := (Sender = FScrollButtonPrevPicture);
