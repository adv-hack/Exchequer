...
// File generated on 5/3/2006 12:22:08 from Type Library described below.
...
// Errors:
//   Error creating palette bitmap of (TDSRClient) : Server mscoree.dll contains no icons
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
...
// *********************************************************************//
  IDSRClientDisp = dispinterface
    ...
    function DSR_SyncRequest(const MachineName: WideString; PortNumber: Integer; 
                             pCompany: LongWord; const pSubj: WideString; const pFrom: WideString; 
                             const pTo: WideString; const pParam1: WideString; 
                             const pParam2: WideString): LongWord; dispid 1610743828;
    function DSR_CreateCompany(const MachineName: WideString; PortNumber: Integer; 
                               const pCompanyName: WideString; const pCompanyCode: WideString): LongWord; dispid 1610743829;
    function DSR_AddNewUser(const MachineName: WideString; PortNumber: Integer; 
                            const pUserName: WideString; const pUserLogin: WideString; 
                            const pUserPassword: WideString): LongWord; dispid 1610743830;
    function DSR_DeleteUser(const MachineName: WideString; PortNumber: Integer; 
                            const pUserLogin: WideString): LongWord; dispid 1610743831;
    function DSR_GetUsers(const MachineName: WideString; PortNumber: Integer; out pUsers: OleVariant): LongWord; dispid 1610743832;
    function DSR_GetContacts(const MachineName: WideString; PortNumber: Integer; 
                             out pContacts: OleVariant): LongWord; dispid 1610743833;
    function DSR_DeleteContact(const MachineName: WideString; PortNumber: Integer; 
                               const pContactMail: WideString): LongWord; dispid 1610743834;
    function DSR_AddNewContact(const MachineName: WideString; PortNumber: Integer; 
                               const pContactName: WideString; const pContactMail: WideString): LongWord; dispid 1610743835;
    function DSR_UpdateDSRSettings(const MachineName: WideString; PortNumber: Integer; 
                                   const pSection: WideString; const pItem: WideString; 
                                   const pValue: WideString; pOption: {??Shortint}OleVariant): LongWord; dispid 1610743836;
    function DSR_UpdateMailSettings(const MachineName: WideString; PortNumber: Integer; 
                                    const pSection: WideString; const pItem: WideString; 
                                    const pValue: WideString; pOption: {??Shortint}OleVariant): LongWord; dispid 1610743837;
  end;
