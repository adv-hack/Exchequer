...
// File generated on 04/12/2006 12:38:27 from Type Library described below.
...
// *********************************************************************//
  IDSRClient = interface(IDispatch)
    ...
    function DSR_GetExPeriodYear(const MachineName: WideString; PortNumber: Integer; 
                                 pCompany: LongWord; out pPeriodYear1: WideString; 
                                 out pPeriodYear2: WideString): LongWord; safecall;
    function DSR_DenySyncRequest(const MachineName: WideString; PortNumber: Integer; 
                                 pCompany: LongWord; pGuid: TGUID): LongWord; safecall;
    function DSR_CancelDripfeed(const MachineName: WideString; PortNumber: Integer; 
                                pCompany: LongWord; const pFrom: WideString; const pTo: WideString; 
                                const pSubject: WideString): LongWord; safecall;
    function DSR_RestoreMessage(const MachineName: WideString; PortNumber: Integer; pGuid: TGUID): LongWord; safecall;
  end;
...
// *********************************************************************//
  IDSRClientDisp = dispinterface
    ...
    function DSR_GetExPeriodYear(const MachineName: WideString; PortNumber: Integer; 
                                 pCompany: LongWord; out pPeriodYear1: WideString; 
                                 out pPeriodYear2: WideString): LongWord; dispid 1610743855;
    function DSR_DenySyncRequest(const MachineName: WideString; PortNumber: Integer; 
                                 pCompany: LongWord; pGuid: {??TGUID}OleVariant): LongWord; dispid 1610743856;
    function DSR_CancelDripfeed(const MachineName: WideString; PortNumber: Integer; 
                                pCompany: LongWord; const pFrom: WideString; const pTo: WideString; 
                                const pSubject: WideString): LongWord; dispid 1610743857;
    function DSR_RestoreMessage(const MachineName: WideString; PortNumber: Integer; 
                                pGuid: {??TGUID}OleVariant): LongWord; dispid 1610743858;
  end;
...
{$ENDIF}
  ...
  public
    ...
    function DSR_CancelDripfeed(const MachineName: WideString; PortNumber: Integer; 
                                pCompany: LongWord; const pFrom: WideString; const pTo: WideString; 
                                const pSubject: WideString): LongWord;
    function DSR_RestoreMessage(const MachineName: WideString; PortNumber: Integer; pGuid: TGUID): LongWord;
...
function TDSRClient.DSR_GetExPeriodYear(const MachineName: WideString; PortNumber: Integer; 
                                        pCompany: LongWord; out pPeriodYear1: WideString; 
                                        out pPeriodYear2: WideString): LongWord;
begin
  Result := DefaultInterface.DSR_GetExPeriodYear(MachineName, PortNumber, pCompany, pPeriodYear1, 
                                                 pPeriodYear2);
end;

function TDSRClient.DSR_DenySyncRequest(const MachineName: WideString; PortNumber: Integer; 
                                        pCompany: LongWord; pGuid: TGUID): LongWord;
begin
  Result := DefaultInterface.DSR_DenySyncRequest(MachineName, PortNumber, pCompany, pGuid);
end;

function TDSRClient.DSR_CancelDripfeed(const MachineName: WideString; PortNumber: Integer; 
                                       pCompany: LongWord; const pFrom: WideString; 
                                       const pTo: WideString; const pSubject: WideString): LongWord;
begin
  Result := DefaultInterface.DSR_CancelDripfeed(MachineName, PortNumber, pCompany, pFrom, pTo, 
                                                pSubject);
end;

function TDSRClient.DSR_RestoreMessage(const MachineName: WideString; PortNumber: Integer; 
                                       pGuid: TGUID): LongWord;
begin
  Result := DefaultInterface.DSR_RestoreMessage(MachineName, PortNumber, pGuid);
end;
