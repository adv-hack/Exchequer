...
Type
  ...
  Public
    ...
    Class Function SendCISMsg(Const pUserFrom, pUserTo, pSubject, pFiles: String): Longword;
    Class Function SendVAT100Msg(Const pUserFrom, pUserTo, pSubject, pFiles: String): Longword;
  End;
...
{-----------------------------------------------------------------------------
  Procedure: SendVAT100Msg
  Author:    Phil Rogers

  Send a VAT100 message using VAT100 class sending
-----------------------------------------------------------------------------}
Class Function TDSRMail.SendVAT100Msg(Const pUserFrom, pUserTo, pSubject, pFiles: String): Longword;
const
  // Note: This GUID is the same as the one in the TLB file where
  //   CLASS_VAT100Sending is defined.
  // (X:\EXCHLITE\ICE\Source\VAT100Outgoing\VAT100Outgoing_TLB.pas)
  CLASS_VAT100Sending = '{D8213C1E-2EEB-4171-82D9-53984109B526}';
Begin
  Result := SendMsg(pUserFrom, pUserTo, pSubject, '', pFiles, CLASS_VAT100Sending);
End;
