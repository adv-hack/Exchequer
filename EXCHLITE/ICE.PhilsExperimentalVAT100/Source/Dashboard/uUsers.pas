...
const
  cINFO = '%s User Logins';
  cSYSTEM = 'Users for the %s';
  cDESCRIPTION = 'Use the list below to change or remove user access to your %s, and to change passwords.';   
...
Begin
  ...
  lblSystem.Caption := Format(cSYSTEM, [_GetProductName(glProductNameIndex)]);
