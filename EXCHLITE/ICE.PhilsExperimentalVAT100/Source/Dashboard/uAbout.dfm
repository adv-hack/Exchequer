object frmAbout: TfrmAbout
  ...
  object advPanel: TAdvPanel
    ...
    object mmAbout: TMemo
      ...
      Font.Style = []
      Lines.Strings = (
        'Exchequer GovLink Dashboard'
        ''
        #169' Exchequer is a product of Advanced Enterprise '
        'Software Ltd, trading as Advanced Business Solutions '
        'and an Advanced Computer Software Group plc company.  '
        ''
