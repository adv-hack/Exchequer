...
type
  ...
  public
    ...
    destructor Destroy; override;
    procedure BuildTaskDialog(TaskDialog: TTaskDialog);
    procedure SetPositions;
  end;

  function AdvMessageDlgPos(TaskDialog: TTaskDialog; X, Y: Integer): Integer;
...
function CreateAdvMessageDlg(TaskDialog: TTaskDialog): TForm;
begin
  Result := nil;
...
procedure TAdvMessageForm.BuildTaskDialog(TaskDialog: TTaskDialog);
var
  DialogUnits: TPoint;
...
procedure Register;
begin
  RegisterComponents('TMS',[TTaskDialog]);
end;
