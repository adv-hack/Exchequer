object frmDailyScheduleTask: TfrmDailyScheduleTask
  Left = 427
  Top = 274
  ...
  object advSchedule: TAdvPanel
    ...
    object Panel1: TPanel
      ...
      object lblInfo: TLabel
        ...
        Width = 207
        Height = 15
        Caption = 'Dashboard Dripfeed Scheduled Task'
    ...
    object opSchedule: TAdvOfficePager
      Left = 12
      Top = 58
      Width = 637
      Height = 327
      AdvOfficePagerStyler = AdvOfficePagerOfficeStyler
      ActivePage = ofpReceiver
      ...
      OnChange = opScheduleChange
      TabOrder = 0
      TabStop = True
      object ofpReceiver: TAdvOfficePage
        Left = 1
        Top = 26
        Width = 635
        Height = 299
        ...
        object lblReceiverInfo: TLabel
          ...
          Width = 332
          Height = 14
          Caption = 'Select the user you want to receive the scheduled message'
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Arial'
      ...
      object ofpSchedule: TAdvOfficePage
        Left = 1
        Top = 26
        Width = 635
        Height = 299
        ...
        object lblScheduleInfo: TLabel
          ...
          Width = 183
          Height = 14
          Caption = 'Select how this task will perform'
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Arial'
        ...
        inline frmDailyFrame: TfrmDailyFrame
          Left = 2
          Top = 42
          Width = 631
          Height = 255
          ...
          ParentFont = False
          TabOrder = 0
          inherited advPanelSchedule: TAdvPanel
            Width = 631
            Height = 255
            FullHeight = 0
          end
