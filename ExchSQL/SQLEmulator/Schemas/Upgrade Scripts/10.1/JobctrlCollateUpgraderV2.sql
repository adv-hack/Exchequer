--/////////////////////////////////////////////////////////////////////////////
--// Filename		    : jobctrlCollateUpgraderV2.sql
--// Author			    : Trapti Gupta	
--// Date				: 08 June 2017
...
IF EXISTS (
            SELECT *
            FROM   sysobjects tab
            WHERE  (tab.id = object_id('[!ActiveSchema!].jobctrl'))
          )
   AND
   EXISTS (
                SELECT *
...
ALTER TABLE [!ActiveSchema!].[jobctrl] ALTER COLUMN PayRDesc varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS
...
SET       Version = 2
WHERE     SchemaName = 'jobctrl_final.xml' AND Version = 1
