...
Begin
  ...
  With Inv do
  Begin
    FoundOk:=((Currency=TCurr) and (SRunNo=PickRunNo));
         ...
         :  Begin
              ...
              Case Mode of
                ...
                3  :  Begin
                        ...
                        //PR: 25/01/2013 ABSEXCH-13952 Moved the setting of 'TransDate' to before the Set_DocRunStat call instead of after;
