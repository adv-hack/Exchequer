object frmBOMKitWarning: TfrmBOMKitWarning
  Left = 412
  Top = 336
  ...
  object Panel1: TPanel
    ...
    object Label2: TLabel
      ...
      AutoSize = False
      Caption = 
        'You are attemping to change the Kitting Options on a Bill of Mat' +
        'erials which has already had transactions raised against it. Thi' +
        's can cause serious problems in the Stock Control system.'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
    ...
    object SBSPanel2: TSBSPanel
      ...
      object CLMsgL: Label8
        ...
        Alignment = taCenter
        AutoSize = False
        Caption = 'Change BOM Kitting Options'
