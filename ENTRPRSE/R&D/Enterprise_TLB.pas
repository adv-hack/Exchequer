...
// File generated on 09/02/2018 16:40:35 from Type Library described below.

// ************************************************************************  //
// Type Lib: W:\ENTRPRSE\R&D\Enter1.tlb (1)
...
const
  ...
  IID_ICOMSetup5: TGUID = '{6D71F790-0654-4002-946B-34E864E1B5C9}';
  IID_ICOMJobBudget3: TGUID = '{12F8F0F8-504E-4AEE-8DE1-40CD588C5A18}';
  IID_ICOMSetup6: TGUID = '{49E12856-5D1D-4ABA-8E5B-173689568A2A}';
  IID_ICOMTransactionLine6: TGUID = '{64F14F67-9B1C-4D1D-A755-07F4BC4C0E2E}';
  IID_ICOMCustomisation6: TGUID = '{5C5789D7-803C-4B53-8BFA-EDCE2E0F55E1}';
  IID_ICOMTransactionLine7: TGUID = '{FED4175A-B349-444D-82D4-98825D4E8A5B}';
  IID_ICOMSetup7: TGUID = '{1F57A37E-71AC-4225-8892-C3331E9B218C}';
  IID_ICOMSetup8: TGUID = '{D39E2055-FE23-4271-A224-831AD3145FD9}';
  IID_ICOMEmployee3: TGUID = '{4E879958-88A3-49DE-90CF-8398F27222D5}';
  IID_ICOMTransactionLine8: TGUID = '{2645AA8F-3C59-4B88-9951-84FA3CBCB3EC}';
  IID_ICOMTransaction6: TGUID = '{34BF1AD0-3D78-41F3-9F48-9D5FC1615DB2}';
  IID_ICOMSetup9: TGUID = '{FFA1F27B-3A90-40A6-9E9F-D237C29C4E2D}';
  IID_ICOMTransaction7: TGUID = '{EEC75BA0-C995-41F6-B2C9-803A0701384D}';
  IID_ICOMUserProfile2: TGUID = '{09C5083D-7062-415B-B77C-4279BC37A160}';
  IID_ICOMCustomer4: TGUID = '{9C4AAA54-11CB-4F22-89F5-5187F9AECBC8}';
  IID_ICOMStock5: TGUID = '{42E797F2-5D9F-4674-B539-F87480C37AA0}';
  IID_ICOMJob4: TGUID = '{213A1BD0-30AB-4BD0-BB99-6FACFFA73888}';
  IID_ICOMTransaction8: TGUID = '{889CE1BA-14AD-4DF8-A985-B1E83B768BD8}';
  IID_ICOMTransactionLine9: TGUID = '{3204593A-E8C2-4748-B4EE-A6E5C1C3E722}';
  IID_ICOMSetupUserFields3: TGUID = '{55839F03-0612-411D-A667-E27F12C33155}';
  IID_ICOMSetupUserFields4: TGUID = '{DAEE88F8-33E0-49B7-9141-4F19D444919B}';
  IID_ICOMUserProfile3: TGUID = '{5EF3D78F-1D3B-4300-AEFE-6E6453ADDC7A}';
  IID_ICOMEmployee4: TGUID = '{121373B0-87E7-4462-BB9D-A8DDBCB54F7F}';
  IID_IVAT100_Callback: TGUID = '{66B404C0-4917-461F-AF0E-AF859DEE9691}';
  CLASS_VAT100_Callback: TGUID = '{0FD89E6D-3179-4BEE-8976-A03364781CD4}';
  IID_ICOMSetup10: TGUID = '{7BF0FDAC-EEE9-4D84-A226-4BFAAFFFE113}';
  IID_ICOMCustomer5: TGUID = '{8FFC7504-F1BF-42D7-9ADD-853D98ED0034}';
  IID_ICOMCustomer6: TGUID = '{E17770D0-94D5-4D5C-B1B4-8938AB3FB2BB}';
  IID_ICOMTransaction9: TGUID = '{AE55CDFA-2560-4667-B875-75A5113DAB60}';
  IID_ICOMTeleSales2: TGUID = '{AD74DA4C-15CF-4C27-A23F-4D22F7EAF430}';
  IID_ICOMCustomer7: TGUID = '{748101FD-E76D-4331-82F1-FADAEF30E3EF}';
  IID_ICOMSetup11: TGUID = '{A2BC5F81-3827-4996-9402-344F4F170A3E}';
  IID_ICOMStock6: TGUID = '{70E54971-A194-41BC-9EDD-E11001AD1FE5}';
  IID_ICOMTransaction10: TGUID = '{32F6F0FE-CBA5-4FDB-986B-36FA9753F5E1}';
  IID_ICOMCustomer8: TGUID = '{4F481185-B342-4FE6-A3EF-918A456B1A36}';
  IID_ICOMCustomer9: TGUID = '{3470014F-9581-44CE-B1FB-A0865DD2274A}';
  IID_ICOMTransaction11: TGUID = '{A84A57DC-655C-410A-96FE-A63C668A0D16}';
  IID_ICOMTelesales3: TGUID = '{A55ECCD8-B7EA-408B-8C84-42290F8C8E84}';
  IID_ICOMSetupUserFields5: TGUID = '{7F0E8B41-2551-4330-9DD1-84BCEB6A8F37}';
  IID_ICOMSetup12: TGUID = '{7C2C2E9C-438D-426B-9293-14F186253A2D}';
  IID_ICOMCustomer10: TGUID = '{B5ED1039-7EBD-4A55-9DB8-BB4482E9978C}';
  IID_ICOMTransaction12: TGUID = '{38E8BC42-5D99-4D05-9763-47DCBC5325BF}';
  IID_ICOMTransactionLine10: TGUID = '{D69C0F34-EF96-4B1D-A158-A2B3232AE0CE}';
  IID_ICOMTelesales4: TGUID = '{DCCE805C-4142-42ED-A27F-445B77A03B6C}';
  IID_ICOMTransaction13: TGUID = '{722D5C91-36E2-4137-9385-DC700E375155}';
  IID_IRCTGateway: TGUID = '{A80E29BF-B6CE-455B-9F37-AF4ACB5046DA}';
  IID_IRCTPlugin: TGUID = '{C161DE1B-CA50-44FF-8C76-B0CADF69AFF2}';
  IID_ICOMSetupUserFields6: TGUID = '{BBA44BC8-DA42-4A4B-961C-2E5F6CC6696A}';
  IID_ICOMUserProfile4: TGUID = '{D8E9F694-A4C6-4989-8905-8359A39EA7EA}';
  IID_ICOMCustomer11: TGUID = '{D955C0DD-4CA1-41AC-A28C-83256C157B8A}';
  IID_ICOMUserProfile5: TGUID = '{7CF61572-7297-4ABA-A607-4DF0BC71E9DA}';
  IID_ICOMTransaction14: TGUID = '{3A5E60B1-3A11-4146-8541-44D912E94E8E}';
  IID_ICOMEmployee5: TGUID = '{7A9C051D-95BF-40DA-BDEE-1A87103807C5}';
  IID_ICOMSetup13: TGUID = '{EC61ACD2-72D6-43C7-9D0E-17393186EEB8}';
  IID_ICOMSetupGDPR: TGUID = '{4648D17C-BB71-4332-8EFA-D72D72311D78}';
  IID_ICOMSetup14: TGUID = '{5E9DE5B1-0ACE-425B-BDD6-3E8CCB6D6D46}';
  IID_ICOMJob5: TGUID = '{58463F30-F7F3-4A1C-BAFE-BF3B22D12F28}';
  IID_ICOMSetup15: TGUID = '{C9CBD50D-EE4C-411D-ACCB-628084EB67CE}';
  IID_ICOMVersion2: TGUID = '{F13C4582-BC8C-4376-879C-0B12F2DEAB8F}';
...
// Constants for enum TTransactionPPDTakenStatus
type
  TTransactionPPDTakenStatus = TOleEnum;
const
  ptPPDNotTaken = $00000000;
  ptPPDTaken = $00000001;
  ptPPDTakenOutsideTerms = $00000002;

// Constants for enum TCustomerPPDMode
type
  TCustomerPPDMode = TOleEnum;
const
  pmPPDDisabled = $00000000;
  pmPPDEnabledWithAutoJournalCreditNote = $00000001;
  pmPPDEnabledWithAutoCreditNote = $00000002;
  pmPPDEnabledWithManualCreditNote = $00000003;

// Constants for enum TTransactionOrderPaymentElement
type
  TTransactionOrderPaymentElement = TOleEnum;
const
  topeNA = $00000000;
  topeOrder = $00000001;
  topeDeliveryNote = $00000002;
  topeInvoice = $00000003;
  topeOrderPayment = $00000004;
  topeDeliveryPayment = $00000005;
  topeInvoicePayment = $00000006;
  topeOrderRefund = $00000007;
  topeInvoiceRefund = $00000008;

// Constants for enum TTransactionOrderPaymentFlags
type
  TTransactionOrderPaymentFlags = TOleEnum;
const
  opfPaymentTaken = $00000001;
  opfCreditCardAuthorisationTaken = $00000002;
  opfCreditCardPaymentTaken = $00000004;

// Constants for enum TBatchAgeType
type
  TBatchAgeType = TOleEnum;
const
  abDays = $00000000;
  abWeeks = $00000001;
  abMonths = $00000002;

// Constants for enum TRCTStatusCode
type
  TRCTStatusCode = TOleEnum;
const
  rsOk = $00000000;
  rsTransactionNotFound = $00000001;
  rsInvalidGLCode = $00000002;
  rsInvalidCostCentre = $00000003;
  rsInvalidDepartment = $00000004;
  rsInvalidBankGLCurrency = $00000005;
  rsInvalidPPDPaymentDate = $00000006;
  rsBatchPaymentsHeaderNotFound = $00000007;
  rsAccountHeaderNotFound = $00000008;
  rsUnknownError = $00000009;

// Constants for enum TEntityAnonymisationStatus
type
  TEntityAnonymisationStatus = TOleEnum;
const
  asNotRequested = $00000000;
  asPending = $00000001;
  asAnonymised = $00000002;

// Constants for enum TEmployeeStatus
type
  TEmployeeStatus = TOleEnum;
const
  emsOpen = $00000000;
  emsClosed = $00000001;
...
// *********************************************************************//
  ...
  ICOMSetup5 = interface;
  ICOMSetup5Disp = dispinterface;
  ICOMJobBudget3 = interface;
  ICOMJobBudget3Disp = dispinterface;
  ICOMSetup6 = interface;
  ICOMSetup6Disp = dispinterface;
  ICOMTransactionLine6 = interface;
  ICOMTransactionLine6Disp = dispinterface;
  ICOMCustomisation6 = interface;
  ICOMCustomisation6Disp = dispinterface;
  ICOMTransactionLine7 = interface;
  ICOMTransactionLine7Disp = dispinterface;
  ICOMSetup7 = interface;
  ICOMSetup7Disp = dispinterface;
  ICOMSetup8 = interface;
  ICOMSetup8Disp = dispinterface;
  ICOMEmployee3 = interface;
  ICOMEmployee3Disp = dispinterface;
  ICOMTransactionLine8 = interface;
  ICOMTransactionLine8Disp = dispinterface;
  ICOMTransaction6 = interface;
  ICOMTransaction6Disp = dispinterface;
  ICOMSetup9 = interface;
  ICOMSetup9Disp = dispinterface;
  ICOMTransaction7 = interface;
  ICOMTransaction7Disp = dispinterface;
  ICOMUserProfile2 = interface;
  ICOMUserProfile2Disp = dispinterface;
  ICOMCustomer4 = interface;
  ICOMCustomer4Disp = dispinterface;
  ICOMStock5 = interface;
  ICOMStock5Disp = dispinterface;
  ICOMJob4 = interface;
  ICOMJob4Disp = dispinterface;
  ICOMTransaction8 = interface;
  ICOMTransaction8Disp = dispinterface;
  ICOMTransactionLine9 = interface;
  ICOMTransactionLine9Disp = dispinterface;
  ICOMSetupUserFields3 = interface;
  ICOMSetupUserFields3Disp = dispinterface;
  ICOMSetupUserFields4 = interface;
  ICOMSetupUserFields4Disp = dispinterface;
  ICOMUserProfile3 = interface;
  ICOMUserProfile3Disp = dispinterface;
  ICOMEmployee4 = interface;
  ICOMEmployee4Disp = dispinterface;
  IVAT100_Callback = interface;
  IVAT100_CallbackDisp = dispinterface;
  ICOMSetup10 = interface;
  ICOMSetup10Disp = dispinterface;
  ICOMCustomer5 = interface;
  ICOMCustomer5Disp = dispinterface;
  ICOMCustomer6 = interface;
  ICOMCustomer6Disp = dispinterface;
  ICOMTransaction9 = interface;
  ICOMTransaction9Disp = dispinterface;
  ICOMTeleSales2 = interface;
  ICOMTeleSales2Disp = dispinterface;
  ICOMCustomer7 = interface;
  ICOMCustomer7Disp = dispinterface;
  ICOMSetup11 = interface;
  ICOMSetup11Disp = dispinterface;
  ICOMStock6 = interface;
  ICOMStock6Disp = dispinterface;
  ICOMTransaction10 = interface;
  ICOMTransaction10Disp = dispinterface;
  ICOMCustomer8 = interface;
  ICOMCustomer8Disp = dispinterface;
  ICOMCustomer9 = interface;
  ICOMCustomer9Disp = dispinterface;
  ICOMTransaction11 = interface;
  ICOMTransaction11Disp = dispinterface;
  ICOMTelesales3 = interface;
  ICOMTelesales3Disp = dispinterface;
  ICOMSetupUserFields5 = interface;
  ICOMSetupUserFields5Disp = dispinterface;
  ICOMSetup12 = interface;
  ICOMSetup12Disp = dispinterface;
  ICOMCustomer10 = interface;
  ICOMCustomer10Disp = dispinterface;
  ICOMTransaction12 = interface;
  ICOMTransaction12Disp = dispinterface;
  ICOMTransactionLine10 = interface;
  ICOMTransactionLine10Disp = dispinterface;
  ICOMTelesales4 = interface;
  ICOMTelesales4Disp = dispinterface;
  ICOMTransaction13 = interface;
  ICOMTransaction13Disp = dispinterface;
  IRCTGateway = interface;
  IRCTGatewayDisp = dispinterface;
  IRCTPlugin = interface;
  IRCTPluginDisp = dispinterface;
  ICOMSetupUserFields6 = interface;
  ICOMSetupUserFields6Disp = dispinterface;
  ICOMUserProfile4 = interface;
  ICOMUserProfile4Disp = dispinterface;
  ICOMCustomer11 = interface;
  ICOMCustomer11Disp = dispinterface;
  ICOMUserProfile5 = interface;
  ICOMUserProfile5Disp = dispinterface;
  ICOMTransaction14 = interface;
  ICOMTransaction14Disp = dispinterface;
  ICOMEmployee5 = interface;
  ICOMEmployee5Disp = dispinterface;
  ICOMSetup13 = interface;
  ICOMSetup13Disp = dispinterface;
  ICOMSetupGDPR = interface;
  ICOMSetupGDPRDisp = dispinterface;
  ICOMSetup14 = interface;
  ICOMSetup14Disp = dispinterface;
  ICOMJob5 = interface;
  ICOMJob5Disp = dispinterface;
  ICOMSetup15 = interface;
  ICOMSetup15Disp = dispinterface;
  ICOMVersion2 = interface;
  ICOMVersion2Disp = dispinterface;
...
// *********************************************************************//
  ...
  VAT100_Callback = IVAT100_Callback;
...
// *********************************************************************//
  ICOMCustomisationDisp = dispinterface
    ['{95BEDB61-A8B0-11D3-A990-0080C87D89BD}']
    property ClassVersion: WideString readonly dispid 1610743808;
...
// *********************************************************************//
// Interface: ICOMSetup5
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {6D71F790-0654-4002-946B-34E864E1B5C9}
// *********************************************************************//
  ICOMSetup5 = interface(ICOMSetup4)
    ['{6D71F790-0654-4002-946B-34E864E1B5C9}']
    function Get_ssGetConnectInfo: WideString; safecall;
    property ssGetConnectInfo: WideString read Get_ssGetConnectInfo;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetup5Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {6D71F790-0654-4002-946B-34E864E1B5C9}
// *********************************************************************//
  ICOMSetup5Disp = dispinterface
    ['{6D71F790-0654-4002-946B-34E864E1B5C9}']
    property ssGetConnectInfo: WideString readonly dispid 112;
    property ssFilterSNoByBinLoc: WordBool readonly dispid 109;
    property ssKeepBinHistory: WordBool readonly dispid 110;
    property ssBinMask: WideString readonly dispid 111;
    property ssCISSetup: ICOMSetupCIS readonly dispid 107;
...
// *********************************************************************//
// Interface: ICOMJobBudget3
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {12F8F0F8-504E-4AEE-8DE1-40CD588C5A18}
// *********************************************************************//
  ICOMJobBudget3 = interface(ICOMJobBudget2)
    ['{12F8F0F8-504E-4AEE-8DE1-40CD588C5A18}']
    function Get_jbBudgetCurrency: Smallint; safecall;
    procedure Set_jbBudgetCurrency(Value: Smallint); safecall;
    property jbBudgetCurrency: Smallint read Get_jbBudgetCurrency write Set_jbBudgetCurrency;
  end;

// *********************************************************************//
// DispIntf:  ICOMJobBudget3Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {12F8F0F8-504E-4AEE-8DE1-40CD588C5A18}
// *********************************************************************//
  ICOMJobBudget3Disp = dispinterface
    ['{12F8F0F8-504E-4AEE-8DE1-40CD588C5A18}']
    property jbBudgetCurrency: Smallint dispid 21;
    property jbOrigValuation: Double dispid 17;
    property jbRevValuation: Double dispid 18;
    property jbValuationPercentage: Double dispid 19;
    property jbValuationBasis: Integer dispid 20;
...
// *********************************************************************//
// Interface: ICOMSetup6
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {49E12856-5D1D-4ABA-8E5B-173689568A2A}
// *********************************************************************//
  ICOMSetup6 = interface(ICOMSetup5)
    ['{49E12856-5D1D-4ABA-8E5B-173689568A2A}']
    function Get_ssUseTransactionTotalDiscounts: WordBool; safecall;
    function Get_ssUseValueBasedDiscounts: WordBool; safecall;
    property ssUseTransactionTotalDiscounts: WordBool read Get_ssUseTransactionTotalDiscounts;
    property ssUseValueBasedDiscounts: WordBool read Get_ssUseValueBasedDiscounts;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetup6Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {49E12856-5D1D-4ABA-8E5B-173689568A2A}
// *********************************************************************//
  ICOMSetup6Disp = dispinterface
    ['{49E12856-5D1D-4ABA-8E5B-173689568A2A}']
    property ssUseTransactionTotalDiscounts: WordBool readonly dispid 113;
    property ssUseValueBasedDiscounts: WordBool readonly dispid 114;
    property ssGetConnectInfo: WideString readonly dispid 112;
    property ssFilterSNoByBinLoc: WordBool readonly dispid 109;
    property ssKeepBinHistory: WordBool readonly dispid 110;
    property ssBinMask: WideString readonly dispid 111;
...
// *********************************************************************//
// Interface: ICOMTransactionLine6
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {64F14F67-9B1C-4D1D-A755-07F4BC4C0E2E}
// *********************************************************************//
  ICOMTransactionLine6 = interface(ICOMTransactionLine5)
    ['{64F14F67-9B1C-4D1D-A755-07F4BC4C0E2E}']
    ...
    function entCalcLineDiscount(SettlementDiscount: Double; 
                                 const SettlementDiscountType: WideString): Double; safecall;
...
// *********************************************************************//
// DispIntf:  ICOMTransactionLine6Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {64F14F67-9B1C-4D1D-A755-07F4BC4C0E2E}
// *********************************************************************//
  ICOMTransactionLine6Disp = dispinterface
    ['{64F14F67-9B1C-4D1D-A755-07F4BC4C0E2E}']
    property tlMultiBuyDiscount: Double dispid 72;
    property tlMultiBuyDiscountFlag: WideString dispid 73;
    property tlTransValueDiscount: Double dispid 74;
    property tlTransValueDiscountFlag: WideString dispid 75;
    property tlTransValueDiscountType: Smallint dispid 76;
    function entCalcLineDiscount(SettlementDiscount: Double; 
                                 const SettlementDiscountType: WideString): Double; dispid 77;
    property tlSerialReturnQty: Double dispid 70;
    property tlBinReturnQty: Double dispid 71;
    property tlCISAdjustments: Double dispid 68;
    property tlAppsDeductType: Integer dispid 69;
...
// *********************************************************************//
// Interface: ICOMCustomisation6
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {5C5789D7-803C-4B53-8BFA-EDCE2E0F55E1}
// *********************************************************************//
  ICOMCustomisation6 = interface(ICOMCustomisation5)
    ['{5C5789D7-803C-4B53-8BFA-EDCE2E0F55E1}']
...
// *********************************************************************//
// DispIntf:  ICOMCustomisation6Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {5C5789D7-803C-4B53-8BFA-EDCE2E0F55E1}
// *********************************************************************//
  ICOMCustomisation6Disp = dispinterface
    ...
    function entCalc_PcntPcntAD(Amount: Double; Discount: Double; const DiscountChr: WideString; 
                                Discount2: Double; const Discount2Chr: WideString; 
                                Discount3: Double; const Discount3Chr: WideString; 
                                SettleDiscount: Double; const SettleDiscountFlag: WideString): Double; dispid 17;
    property SystemSetup3: ICOMSetup4 readonly dispid 16;
    property SystemSetup2: ICOMSetup3 readonly dispid 15;
    property UserProfile: ICOMUserProfile readonly dispid 13;
    function HookPointEnabled(WindowId: Integer; HandlerId: Integer): WordBool; dispid 14;
...
// *********************************************************************//
// Interface: ICOMTransactionLine7
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {FED4175A-B349-444D-82D4-98825D4E8A5B}
// *********************************************************************//
  ICOMTransactionLine7 = interface(ICOMTransactionLine6)
    ['{FED4175A-B349-444D-82D4-98825D4E8A5B}']
    ...
    property tlServiceStartDate: WideString read Get_tlServiceStartDate write Set_tlServiceStartDate;
    property tlServiceEndDate: WideString read Get_tlServiceEndDate write Set_tlServiceEndDate;
    property tlECSalesTaxReported: Double read Get_tlECSalesTaxReported write Set_tlECSalesTaxReported;
    property tlPurchaseServiceTax: Double read Get_tlPurchaseServiceTax write Set_tlPurchaseServiceTax;
  end;

// *********************************************************************//
// DispIntf:  ICOMTransactionLine7Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {FED4175A-B349-444D-82D4-98825D4E8A5B}
// *********************************************************************//
  ICOMTransactionLine7Disp = dispinterface
    ['{FED4175A-B349-444D-82D4-98825D4E8A5B}']
    property tlECService: WordBool dispid 78;
    property tlServiceStartDate: WideString dispid 79;
    property tlServiceEndDate: WideString dispid 80;
    property tlECSalesTaxReported: Double dispid 81;
    property tlPurchaseServiceTax: Double dispid 82;
    property tlMultiBuyDiscount: Double dispid 72;
    property tlMultiBuyDiscountFlag: WideString dispid 73;
    property tlTransValueDiscount: Double dispid 74;
    property tlTransValueDiscountFlag: WideString dispid 75;
...
// *********************************************************************//
// Interface: ICOMSetup7
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {1F57A37E-71AC-4225-8892-C3331E9B218C}
// *********************************************************************//
  ICOMSetup7 = interface(ICOMSetup6)
    ['{1F57A37E-71AC-4225-8892-C3331E9B218C}']
    function Get_ssEnableECServices: WordBool; safecall;
    function Get_ssECSalesThreshold: Double; safecall;
    property ssEnableECServices: WordBool read Get_ssEnableECServices;
    property ssECSalesThreshold: Double read Get_ssECSalesThreshold;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetup7Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {1F57A37E-71AC-4225-8892-C3331E9B218C}
// *********************************************************************//
  ICOMSetup7Disp = dispinterface
    ['{1F57A37E-71AC-4225-8892-C3331E9B218C}']
    property ssEnableECServices: WordBool readonly dispid 115;
    property ssECSalesThreshold: Double readonly dispid 116;
    property ssUseTransactionTotalDiscounts: WordBool readonly dispid 113;
    property ssUseValueBasedDiscounts: WordBool readonly dispid 114;
    property ssGetConnectInfo: WideString readonly dispid 112;
    property ssFilterSNoByBinLoc: WordBool readonly dispid 109;
...
// *********************************************************************//
// Interface: ICOMSetup8
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D39E2055-FE23-4271-A224-831AD3145FD9}
// *********************************************************************//
  ICOMSetup8 = interface(ICOMSetup7)
    ['{D39E2055-FE23-4271-A224-831AD3145FD9}']
    function Get_ssCompanyCode: WideString; safecall;
    property ssCompanyCode: WideString read Get_ssCompanyCode;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetup8Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D39E2055-FE23-4271-A224-831AD3145FD9}
// *********************************************************************//
  ICOMSetup8Disp = dispinterface
    ['{D39E2055-FE23-4271-A224-831AD3145FD9}']
    property ssCompanyCode: WideString readonly dispid 117;
    property ssEnableECServices: WordBool readonly dispid 115;
    property ssECSalesThreshold: Double readonly dispid 116;
    property ssUseTransactionTotalDiscounts: WordBool readonly dispid 113;
    property ssUseValueBasedDiscounts: WordBool readonly dispid 114;
...
// *********************************************************************//
// Interface: ICOMEmployee3
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {4E879958-88A3-49DE-90CF-8398F27222D5}
// *********************************************************************//
  ICOMEmployee3 = interface(ICOMEmployee2)
    ['{4E879958-88A3-49DE-90CF-8398F27222D5}']
    function Get_emEmailAddr: WideString; safecall;
    procedure Set_emEmailAddr(const Value: WideString); safecall;
    property emEmailAddr: WideString read Get_emEmailAddr write Set_emEmailAddr;
  end;

// *********************************************************************//
// DispIntf:  ICOMEmployee3Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {4E879958-88A3-49DE-90CF-8398F27222D5}
// *********************************************************************//
  ICOMEmployee3Disp = dispinterface
    ['{4E879958-88A3-49DE-90CF-8398F27222D5}']
    property emEmailAddr: WideString dispid 25;
    property emLabourViaPL: WordBool dispid 24;
    property AccessRights: TRecordAccessStatus readonly dispid 1;
    property emCode: WideString dispid 2;
    property emSupplier: WideString dispid 3;
...
// *********************************************************************//
// Interface: ICOMTransactionLine8
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {2645AA8F-3C59-4B88-9951-84FA3CBCB3EC}
// *********************************************************************//
  ICOMTransactionLine8 = interface(ICOMTransactionLine7)
    ['{2645AA8F-3C59-4B88-9951-84FA3CBCB3EC}']
...
// *********************************************************************//
// DispIntf:  ICOMTransactionLine8Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {2645AA8F-3C59-4B88-9951-84FA3CBCB3EC}
// *********************************************************************//
  ICOMTransactionLine8Disp = dispinterface
    ['{2645AA8F-3C59-4B88-9951-84FA3CBCB3EC}']
    property tlReference: WideString dispid 83;
    property tlReceiptNo: WideString dispid 84;
    property tlFromPostCode: WideString dispid 85;
    property tlToPostCode: WideString dispid 86;
    property tlECService: WordBool dispid 78;
    property tlServiceStartDate: WideString dispid 79;
    property tlServiceEndDate: WideString dispid 80;
    property tlECSalesTaxReported: Double dispid 81;
...
// *********************************************************************//
// Interface: ICOMTransaction6
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {34BF1AD0-3D78-41F3-9F48-9D5FC1615DB2}
// *********************************************************************//
  ICOMTransaction6 = interface(ICOMTransaction5)
    ['{34BF1AD0-3D78-41F3-9F48-9D5FC1615DB2}']
    ...
    property thWeekMonth: Integer read Get_thWeekMonth write Set_thWeekMonth;
    property thWorkflowState: Integer read Get_thWorkflowState write Set_thWorkflowState;
  end;

// *********************************************************************//
// DispIntf:  ICOMTransaction6Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {34BF1AD0-3D78-41F3-9F48-9D5FC1615DB2}
// *********************************************************************//
  ICOMTransaction6Disp = dispinterface
    ['{34BF1AD0-3D78-41F3-9F48-9D5FC1615DB2}']
    property thWeekMonth: Integer dispid 94;
    property thWorkflowState: Integer dispid 95;
    property thTSHExported: WordBool dispid 93;
    property thNOMVATIO: TNOMVATIOType dispid 87;
    property thCISTaxDue: Double dispid 84;
    property thCISTaxDeclared: Double dispid 85;
...
// *********************************************************************//
// Interface: ICOMSetup9
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {FFA1F27B-3A90-40A6-9E9F-D237C29C4E2D}
// *********************************************************************//
  ICOMSetup9 = interface(ICOMSetup8)
    ['{FFA1F27B-3A90-40A6-9E9F-D237C29C4E2D}']
    function Get_ssEnableOverrideLocation: WordBool; safecall;
    property ssEnableOverrideLocation: WordBool read Get_ssEnableOverrideLocation;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetup9Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {FFA1F27B-3A90-40A6-9E9F-D237C29C4E2D}
// *********************************************************************//
  ICOMSetup9Disp = dispinterface
    ['{FFA1F27B-3A90-40A6-9E9F-D237C29C4E2D}']
    property ssEnableOverrideLocation: WordBool readonly dispid 118;
    property ssCompanyCode: WideString readonly dispid 117;
    property ssEnableECServices: WordBool readonly dispid 115;
    property ssECSalesThreshold: Double readonly dispid 116;
    property ssUseTransactionTotalDiscounts: WordBool readonly dispid 113;
...
// *********************************************************************//
// Interface: ICOMTransaction7
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {EEC75BA0-C995-41F6-B2C9-803A0701384D}
// *********************************************************************//
  ICOMTransaction7 = interface(ICOMTransaction6)
    ['{EEC75BA0-C995-41F6-B2C9-803A0701384D}']
...
// *********************************************************************//
// DispIntf:  ICOMTransaction7Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {EEC75BA0-C995-41F6-B2C9-803A0701384D}
// *********************************************************************//
  ICOMTransaction7Disp = dispinterface
    ['{EEC75BA0-C995-41F6-B2C9-803A0701384D}']
    property thOverrideLocation: WideString dispid 96;
    property thWeekMonth: Integer dispid 94;
    property thWorkflowState: Integer dispid 95;
    property thTSHExported: WordBool dispid 93;
    property thNOMVATIO: TNOMVATIOType dispid 87;
...
// *********************************************************************//
// Interface: ICOMUserProfile2
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {09C5083D-7062-415B-B77C-4279BC37A160}
// *********************************************************************//
  ICOMUserProfile2 = interface(ICOMUserProfile)
    ['{09C5083D-7062-415B-B77C-4279BC37A160}']
    function Get_upShowGLCodesInTree: WordBool; safecall;
    property upShowGLCodesInTree: WordBool read Get_upShowGLCodesInTree;
  end;

// *********************************************************************//
// DispIntf:  ICOMUserProfile2Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {09C5083D-7062-415B-B77C-4279BC37A160}
// *********************************************************************//
  ICOMUserProfile2Disp = dispinterface
    ['{09C5083D-7062-415B-B77C-4279BC37A160}']
    property upShowGLCodesInTree: WordBool readonly dispid 1;
    property upUserId: WideString readonly dispid 2;
    property upName: WideString readonly dispid 3;
    property upEmail: WideString readonly dispid 4;
    property upLockOutMins: Integer readonly dispid 5;
...
// *********************************************************************//
// Interface: ICOMCustomer4
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {9C4AAA54-11CB-4F22-89F5-5187F9AECBC8}
// *********************************************************************//
  ICOMCustomer4 = interface(ICOMCustomer3)
    ['{9C4AAA54-11CB-4F22-89F5-5187F9AECBC8}']
...
// *********************************************************************//
// DispIntf:  ICOMCustomer4Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {9C4AAA54-11CB-4F22-89F5-5187F9AECBC8}
// *********************************************************************//
  ICOMCustomer4Disp = dispinterface
    ['{9C4AAA54-11CB-4F22-89F5-5187F9AECBC8}']
    property acUserDef5: WideString dispid 74;
    property acUserDef6: WideString dispid 75;
    property acUserDef7: WideString dispid 76;
    property acUserDef8: WideString dispid 77;
    property acUserDef9: WideString dispid 78;
    property acUserDef10: WideString dispid 79;
    property acStateDeliveryMode: Integer dispid 72;
    property acHeadOffice: Integer dispid 73;
    property acDefTagNo: Integer dispid 53;
    property acDefSettleDisc: Double dispid 54;
...
// *********************************************************************//
// Interface: ICOMStock5
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {42E797F2-5D9F-4674-B539-F87480C37AA0}
// *********************************************************************//
  ICOMStock5 = interface(ICOMStock4)
    ['{42E797F2-5D9F-4674-B539-F87480C37AA0}']
    ...
    property stStkUser5: WideString read Get_stStkUser5 write Set_stStkUser5;
    property stStkUser6: WideString read Get_stStkUser6 write Set_stStkUser6;
    property stStkUser7: WideString read Get_stStkUser7 write Set_stStkUser7;
    property stStkUser8: WideString read Get_stStkUser8 write Set_stStkUser8;
    property stStkUser9: WideString read Get_stStkUser9 write Set_stStkUser9;
    property stStkUser10: WideString read Get_stStkUser10 write Set_stStkUser10;
  end;

// *********************************************************************//
// DispIntf:  ICOMStock5Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {42E797F2-5D9F-4674-B539-F87480C37AA0}
// *********************************************************************//
  ICOMStock5Disp = dispinterface
    ['{42E797F2-5D9F-4674-B539-F87480C37AA0}']
    property stStkUser5: WideString dispid 107;
    property stStkUser6: WideString dispid 108;
    property stStkUser7: WideString dispid 109;
    property stStkUser8: WideString dispid 110;
    property stStkUser9: WideString dispid 111;
    property stStkUser10: WideString dispid 112;
    property stSalesWarrantyLength: Integer dispid 97;
    property stSalesWarrantyUnits: TStockWarrantyUnits dispid 98;
    property stManufacturerWarrantyLength: Integer dispid 99;
    property stManufacturerWarrantyUnits: TStockWarrantyUnits dispid 100;
...
// Interface: ICOMJob4
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {213A1BD0-30AB-4BD0-BB99-6FACFFA73888}
// *********************************************************************//
  ICOMJob4 = interface(ICOMJob3)
    ['{213A1BD0-30AB-4BD0-BB99-6FACFFA73888}']
    ...
    property jrUserDef5: WideString read Get_jrUserDef5 write Set_jrUserDef5;
    property jrUserDef6: WideString read Get_jrUserDef6 write Set_jrUserDef6;
    property jrUserDef7: WideString read Get_jrUserDef7 write Set_jrUserDef7;
    property jrUserDef8: WideString read Get_jrUserDef8 write Set_jrUserDef8;
    property jrUserDef9: WideString read Get_jrUserDef9 write Set_jrUserDef9;
    property jrUserDef10: WideString read Get_jrUserDef10 write Set_jrUserDef10;
  end;

// *********************************************************************//
// DispIntf:  ICOMJob4Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {213A1BD0-30AB-4BD0-BB99-6FACFFA73888}
// *********************************************************************//
  ICOMJob4Disp = dispinterface
    ['{213A1BD0-30AB-4BD0-BB99-6FACFFA73888}']
    property jrUserDef5: WideString dispid 34;
    property jrUserDef6: WideString dispid 35;
    property jrUserDef7: WideString dispid 36;
    property jrUserDef8: WideString dispid 37;
    property jrUserDef9: WideString dispid 38;
    property jrUserDef10: WideString dispid 39;
    property jrDefRetentionCcy: Integer dispid 30;
    property jrJPTRef: WideString dispid 31;
    property jrJSTRef: WideString dispid 32;
    property jrQSCode: WideString dispid 33;
...
// *********************************************************************//
// Interface: ICOMTransaction8
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {889CE1BA-14AD-4DF8-A985-B1E83B768BD8}
// *********************************************************************//
  ICOMTransaction8 = interface(ICOMTransaction7)
    ['{889CE1BA-14AD-4DF8-A985-B1E83B768BD8}']
    ...
    property thUser5: WideString read Get_thUser5 write Set_thUser5;
    property thUser6: WideString read Get_thUser6 write Set_thUser6;
    property thUser7: WideString read Get_thUser7 write Set_thUser7;
    property thUser8: WideString read Get_thUser8 write Set_thUser8;
    property thUser9: WideString read Get_thUser9 write Set_thUser9;
    property thUser10: WideString read Get_thUser10 write Set_thUser10;
  end;

// *********************************************************************//
// DispIntf:  ICOMTransaction8Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {889CE1BA-14AD-4DF8-A985-B1E83B768BD8}
// *********************************************************************//
  ICOMTransaction8Disp = dispinterface
    ['{889CE1BA-14AD-4DF8-A985-B1E83B768BD8}']
    property thUser5: WideString dispid 97;
    property thUser6: WideString dispid 98;
    property thUser7: WideString dispid 100;
    property thUser8: WideString dispid 101;
    property thUser9: WideString dispid 102;
    property thUser10: WideString dispid 103;
    property thOverrideLocation: WideString dispid 96;
    property thWeekMonth: Integer dispid 94;
    property thWorkflowState: Integer dispid 95;
    property thTSHExported: WordBool dispid 93;
...
// *********************************************************************//
// Interface: ICOMTransactionLine9
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {3204593A-E8C2-4748-B4EE-A6E5C1C3E722}
// *********************************************************************//
  ICOMTransactionLine9 = interface(ICOMTransactionLine8)
    ['{3204593A-E8C2-4748-B4EE-A6E5C1C3E722}']
    ...
    property tlUserDef5: WideString read Get_tlUserDef5 write Set_tlUserDef5;
    property tlUserDef6: WideString read Get_tlUserDef6 write Set_tlUserDef6;
    property tlUserDef7: WideString read Get_tlUserDef7 write Set_tlUserDef7;
    property tlUserDef8: WideString read Get_tlUserDef8 write Set_tlUserDef8;
    property tlUserDef9: WideString read Get_tlUserDef9 write Set_tlUserDef9;
    property tlUserDef10: WideString read Get_tlUserDef10 write Set_tlUserDef10;
  end;

// *********************************************************************//
// DispIntf:  ICOMTransactionLine9Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {3204593A-E8C2-4748-B4EE-A6E5C1C3E722}
// *********************************************************************//
  ICOMTransactionLine9Disp = dispinterface
    ['{3204593A-E8C2-4748-B4EE-A6E5C1C3E722}']
    property tlUserDef5: WideString dispid 87;
    property tlUserDef6: WideString dispid 88;
    property tlUserDef7: WideString dispid 89;
    property tlUserDef8: WideString dispid 90;
    property tlUserDef9: WideString dispid 91;
    property tlUserDef10: WideString dispid 92;
    property tlReference: WideString dispid 83;
    property tlReceiptNo: WideString dispid 84;
    property tlFromPostCode: WideString dispid 85;
    property tlToPostCode: WideString dispid 86;
...
// *********************************************************************//
// Interface: ICOMSetupUserFields3
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {55839F03-0612-411D-A667-E27F12C33155}
// *********************************************************************//
  ICOMSetupUserFields3 = interface(ICOMSetupUserFields2)
    ['{55839F03-0612-411D-A667-E27F12C33155}']
    ...
    property ufLineTypeEnabled[FieldNo: Integer]: WordBool read Get_ufLineTypeEnabled;
    property ufSRNDesc[FieldNo: Integer]: WideString read Get_ufSRNDesc;
    property ufSRNEnabled[FieldNo: Integer]: WordBool read Get_ufSRNEnabled;
    property ufSRNLineDesc[FieldNo: Integer]: WideString read Get_ufSRNLineDesc;
    property ufSRNLineEnabled[FieldNo: Integer]: WordBool read Get_ufSRNLineEnabled;
    property ufPRNDesc[FieldNo: Integer]: WideString read Get_ufPRNDesc;
    property ufPRNEnabled[FieldNo: Integer]: WordBool read Get_ufPRNEnabled;
    property ufPRNLineDesc[FieldNo: Integer]: WideString read Get_ufPRNLineDesc;
    property ufPRNLineEnabled[FieldNo: Integer]: WordBool read Get_ufPRNLineEnabled;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetupUserFields3Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {55839F03-0612-411D-A667-E27F12C33155}
// *********************************************************************//
  ICOMSetupUserFields3Disp = dispinterface
    ['{55839F03-0612-411D-A667-E27F12C33155}']
    property ufLineTypeEnabled[FieldNo: Integer]: WordBool readonly dispid 81;
    property ufSRNDesc[FieldNo: Integer]: WideString readonly dispid 82;
    property ufSRNEnabled[FieldNo: Integer]: WordBool readonly dispid 83;
    property ufSRNLineDesc[FieldNo: Integer]: WideString readonly dispid 84;
    property ufSRNLineEnabled[FieldNo: Integer]: WordBool readonly dispid 85;
    property ufPRNDesc[FieldNo: Integer]: WideString readonly dispid 86;
    property ufPRNEnabled[FieldNo: Integer]: WordBool readonly dispid 87;
    property ufPRNLineDesc[FieldNo: Integer]: WideString readonly dispid 88;
    property ufPRNLineEnabled[FieldNo: Integer]: WordBool readonly dispid 89;
    property ufCustDesc[FieldNo: Integer]: WideString readonly dispid 19;
    property ufSuppDesc[FieldNo: Integer]: WideString readonly dispid 73;
    property ufLineTypeDesc[FieldNo: Integer]: WideString readonly dispid 74;
    property ufSINDesc[FieldNo: Integer]: WideString readonly dispid 75;
...
// *********************************************************************//
// Interface: ICOMSetupUserFields4
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {DAEE88F8-33E0-49B7-9141-4F19D444919B}
// *********************************************************************//
  ICOMSetupUserFields4 = interface(ICOMSetupUserFields3)
    ['{DAEE88F8-33E0-49B7-9141-4F19D444919B}']
    ...
    property ufJCTDesc[FieldNo: Integer]: WideString read Get_ufJCTDesc;
    property ufJCTEnabled[FieldNo: Integer]: WordBool read Get_ufJCTEnabled;
    property ufJCTLineDesc[FieldNo: Integer]: WideString read Get_ufJCTLineDesc;
    property ufJCTLineEnabled[FieldNo: Integer]: WordBool read Get_ufJCTLineEnabled;
    property ufJPTDesc[FieldNo: Integer]: WideString read Get_ufJPTDesc;
    property ufJPTEnabled[FieldNo: Integer]: WordBool read Get_ufJPTEnabled;
    property ufJPTLineDesc[FieldNo: Integer]: WideString read Get_ufJPTLineDesc;
    property ufJPTLineEnabled[FieldNo: Integer]: WordBool read Get_ufJPTLineEnabled;
    property ufJSTDesc[FieldNo: Integer]: WideString read Get_ufJSTDesc;
    property ufJSTEnabled[FieldNo: Integer]: WordBool read Get_ufJSTEnabled;
    property ufJSTLineDesc[FieldNo: Integer]: WideString read Get_ufJSTLineDesc;
    property ufJSTLineEnabled[FieldNo: Integer]: WordBool read Get_ufJSTLineEnabled;
    property ufJPADesc[FieldNo: Integer]: WideString read Get_ufJPADesc;
    property ufJPAEnabled[FieldNo: Integer]: WordBool read Get_ufJPAEnabled;
    property ufJPALineDesc[FieldNo: Integer]: WideString read Get_ufJPALineDesc;
    property ufJPALineEnabled[FieldNo: Integer]: WordBool read Get_ufJPALineEnabled;
    property ufJSADesc[FieldNo: Integer]: WideString read Get_ufJSADesc;
    property ufJSAEnabled[FieldNo: Integer]: WordBool read Get_ufJSAEnabled;
    property ufJSALineDesc[FieldNo: Integer]: WideString read Get_ufJSALineDesc;
    property ufJSALineEnabled[FieldNo: Integer]: WordBool read Get_ufJSALineEnabled;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetupUserFields4Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {DAEE88F8-33E0-49B7-9141-4F19D444919B}
// *********************************************************************//
  ICOMSetupUserFields4Disp = dispinterface
    ['{DAEE88F8-33E0-49B7-9141-4F19D444919B}']
    property ufJCTDesc[FieldNo: Integer]: WideString readonly dispid 90;
    property ufJCTEnabled[FieldNo: Integer]: WordBool readonly dispid 91;
    property ufJCTLineDesc[FieldNo: Integer]: WideString readonly dispid 92;
    property ufJCTLineEnabled[FieldNo: Integer]: WordBool readonly dispid 93;
    property ufJPTDesc[FieldNo: Integer]: WideString readonly dispid 94;
    property ufJPTEnabled[FieldNo: Integer]: WordBool readonly dispid 95;
    property ufJPTLineDesc[FieldNo: Integer]: WideString readonly dispid 96;
    property ufJPTLineEnabled[FieldNo: Integer]: WordBool readonly dispid 97;
    property ufJSTDesc[FieldNo: Integer]: WideString readonly dispid 98;
    property ufJSTEnabled[FieldNo: Integer]: WordBool readonly dispid 99;
    property ufJSTLineDesc[FieldNo: Integer]: WideString readonly dispid 100;
    property ufJSTLineEnabled[FieldNo: Integer]: WordBool readonly dispid 101;
    property ufJPADesc[FieldNo: Integer]: WideString readonly dispid 102;
    property ufJPAEnabled[FieldNo: Integer]: WordBool readonly dispid 103;
    property ufJPALineDesc[FieldNo: Integer]: WideString readonly dispid 104;
    property ufJPALineEnabled[FieldNo: Integer]: WordBool readonly dispid 105;
    property ufJSADesc[FieldNo: Integer]: WideString readonly dispid 106;
    property ufJSAEnabled[FieldNo: Integer]: WordBool readonly dispid 107;
    property ufJSALineDesc[FieldNo: Integer]: WideString readonly dispid 108;
    property ufJSALineEnabled[FieldNo: Integer]: WordBool readonly dispid 109;
    property ufLineTypeEnabled[FieldNo: Integer]: WordBool readonly dispid 81;
    property ufSRNDesc[FieldNo: Integer]: WideString readonly dispid 82;
    property ufSRNEnabled[FieldNo: Integer]: WordBool readonly dispid 83;
    property ufSRNLineDesc[FieldNo: Integer]: WideString readonly dispid 84;
...
// *********************************************************************//
// Interface: ICOMUserProfile3
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {5EF3D78F-1D3B-4300-AEFE-6E6453ADDC7A}
// *********************************************************************//
  ICOMUserProfile3 = interface(ICOMUserProfile2)
    ['{5EF3D78F-1D3B-4300-AEFE-6E6453ADDC7A}']
...
// *********************************************************************//
// DispIntf:  ICOMUserProfile3Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {5EF3D78F-1D3B-4300-AEFE-6E6453ADDC7A}
// *********************************************************************//
  ICOMUserProfile3Disp = dispinterface
    ['{5EF3D78F-1D3B-4300-AEFE-6E6453ADDC7A}']
    property upShowProductTypesInTree: WordBool readonly dispid 23;
    property upShowStockCodesInTree: WordBool readonly dispid 24;
    property upShowGLCodesInTree: WordBool readonly dispid 1;
    property upUserId: WideString readonly dispid 2;
    property upName: WideString readonly dispid 3;
    property upEmail: WideString readonly dispid 4;
...
// *********************************************************************//
// Interface: ICOMEmployee4
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {121373B0-87E7-4462-BB9D-A8DDBCB54F7F}
// *********************************************************************//
  ICOMEmployee4 = interface(ICOMEmployee3)
    ['{121373B0-87E7-4462-BB9D-A8DDBCB54F7F}']
    ...
    property emContractorType: Integer read Get_emContractorType write Set_emContractorType;
    property emTagged: Integer read Get_emTagged write Set_emTagged;
    property emTimeRateRules: Integer read Get_emTimeRateRules write Set_emTimeRateRules;
...
// *********************************************************************//
// DispIntf:  ICOMEmployee4Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {121373B0-87E7-4462-BB9D-A8DDBCB54F7F}
// *********************************************************************//
  ICOMEmployee4Disp = dispinterface
    ['{121373B0-87E7-4462-BB9D-A8DDBCB54F7F}']
    property emContractorType: Integer dispid 26;
    property emTagged: Integer dispid 27;
    property emTimeRateRules: Integer dispid 28;
    property emUTRCode: WideString dispid 29;
    property emVerificationNo: WideString dispid 30;
    property emEmailAddr: WideString dispid 25;
    property emLabourViaPL: WordBool dispid 24;
    property AccessRights: TRecordAccessStatus readonly dispid 1;
    property emCode: WideString dispid 2;
...
// *********************************************************************//
// Interface: IVAT100_Callback
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {66B404C0-4917-461F-AF0E-AF859DEE9691}
// *********************************************************************//
  IVAT100_Callback = interface(IDispatch)
    ['{66B404C0-4917-461F-AF0E-AF859DEE9691}']
  end;

// *********************************************************************//
// DispIntf:  IVAT100_CallbackDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {66B404C0-4917-461F-AF0E-AF859DEE9691}
// *********************************************************************//
  IVAT100_CallbackDisp = dispinterface
...
// *********************************************************************//
// Interface: ICOMSetup10
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7BF0FDAC-EEE9-4D84-A226-4BFAAFFFE113}
// *********************************************************************//
  ICOMSetup10 = interface(ICOMSetup9)
    ['{7BF0FDAC-EEE9-4D84-A226-4BFAAFFFE113}']
    function Get_ssBankAccountCode: WideString; safecall;
    function Get_ssBankSortCode: WideString; safecall;
    property ssBankAccountCode: WideString read Get_ssBankAccountCode;
    property ssBankSortCode: WideString read Get_ssBankSortCode;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetup10Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7BF0FDAC-EEE9-4D84-A226-4BFAAFFFE113}
// *********************************************************************//
  ICOMSetup10Disp = dispinterface
    ['{7BF0FDAC-EEE9-4D84-A226-4BFAAFFFE113}']
    property ssBankAccountCode: WideString readonly dispid 119;
    property ssBankSortCode: WideString readonly dispid 120;
    property ssEnableOverrideLocation: WordBool readonly dispid 118;
    property ssCompanyCode: WideString readonly dispid 117;
    property ssEnableECServices: WordBool readonly dispid 115;
    property ssECSalesThreshold: Double readonly dispid 116;
...
// *********************************************************************//
// Interface: ICOMCustomer5
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {8FFC7504-F1BF-42D7-9ADD-853D98ED0034}
// *********************************************************************//
  ICOMCustomer5 = interface(ICOMCustomer4)
    ['{8FFC7504-F1BF-42D7-9ADD-853D98ED0034}']
    ...
    property acBankSortCode: WideString read Get_acBankSortCode write Set_acBankSortCode;
    property acBankAccountCode: WideString read Get_acBankAccountCode write Set_acBankAccountCode;
    property acMandateID: WideString read Get_acMandateID write Set_acMandateID;
    property acMandateDate: WideString read Get_acMandateDate write Set_acMandateDate;
  end;

// *********************************************************************//
// DispIntf:  ICOMCustomer5Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {8FFC7504-F1BF-42D7-9ADD-853D98ED0034}
// *********************************************************************//
  ICOMCustomer5Disp = dispinterface
    ['{8FFC7504-F1BF-42D7-9ADD-853D98ED0034}']
    property acBankSortCode: WideString dispid 80;
    property acBankAccountCode: WideString dispid 81;
    property acMandateID: WideString dispid 82;
    property acMandateDate: WideString dispid 83;
    property acUserDef5: WideString dispid 74;
    property acUserDef6: WideString dispid 75;
    property acUserDef7: WideString dispid 76;
    property acUserDef8: WideString dispid 77;
...
// *********************************************************************//
// Interface: ICOMCustomer6
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {E17770D0-94D5-4D5C-B1B4-8938AB3FB2BB}
// *********************************************************************//
  ICOMCustomer6 = interface(ICOMCustomer5)
    ['{E17770D0-94D5-4D5C-B1B4-8938AB3FB2BB}']
    function Get_acDeliveryPostCode: WideString; safecall;
    procedure Set_acDeliveryPostCode(const Value: WideString); safecall;
    property acDeliveryPostCode: WideString read Get_acDeliveryPostCode write Set_acDeliveryPostCode;
  end;

// *********************************************************************//
// DispIntf:  ICOMCustomer6Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {E17770D0-94D5-4D5C-B1B4-8938AB3FB2BB}
// *********************************************************************//
  ICOMCustomer6Disp = dispinterface
    ['{E17770D0-94D5-4D5C-B1B4-8938AB3FB2BB}']
    property acDeliveryPostCode: WideString dispid 84;
    property acBankSortCode: WideString dispid 80;
    property acBankAccountCode: WideString dispid 81;
    property acMandateID: WideString dispid 82;
    property acMandateDate: WideString dispid 83;
...
// *********************************************************************//
// Interface: ICOMTransaction9
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {AE55CDFA-2560-4667-B875-75A5113DAB60}
// *********************************************************************//
  ICOMTransaction9 = interface(ICOMTransaction8)
    ['{AE55CDFA-2560-4667-B875-75A5113DAB60}']
    ...
    property thOriginator: WideString read Get_thOriginator write Set_thOriginator;
    property thCreationTime: WideString read Get_thCreationTime write Set_thCreationTime;
    property thCreationDate: WideString read Get_thCreationDate write Set_thCreationDate;
  end;

// *********************************************************************//
// DispIntf:  ICOMTransaction9Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {AE55CDFA-2560-4667-B875-75A5113DAB60}
// *********************************************************************//
  ICOMTransaction9Disp = dispinterface
    ['{AE55CDFA-2560-4667-B875-75A5113DAB60}']
    property thDeliveryPostCode: WideString dispid 99;
    property thOriginator: WideString dispid 104;
    property thCreationTime: WideString dispid 105;
    property thCreationDate: WideString dispid 106;
    property thUser5: WideString dispid 97;
    property thUser6: WideString dispid 98;
    property thUser7: WideString dispid 100;
    property thUser8: WideString dispid 101;
...
// *********************************************************************//
// Interface: ICOMTeleSales2
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {AD74DA4C-15CF-4C27-A23F-4D22F7EAF430}
// *********************************************************************//
  ICOMTeleSales2 = interface(ICOMTelesales)
    ['{AD74DA4C-15CF-4C27-A23F-4D22F7EAF430}']
    function Get_teDeliveryPostCode: WideString; safecall;
    procedure Set_teDeliveryPostCode(const Value: WideString); safecall;
    property teDeliveryPostCode: WideString read Get_teDeliveryPostCode write Set_teDeliveryPostCode;
  end;

// *********************************************************************//
// DispIntf:  ICOMTeleSales2Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {AD74DA4C-15CF-4C27-A23F-4D22F7EAF430}
// *********************************************************************//
  ICOMTeleSales2Disp = dispinterface
    ['{AD74DA4C-15CF-4C27-A23F-4D22F7EAF430}']
    property teDeliveryPostCode: WideString dispid 35;
    property teCustCode: WideString dispid 1;
    property teCurrency: Integer dispid 2;
    property teCompanyRate: Double dispid 3;
    property teDailyRate: Double dispid 4;
...
// *********************************************************************//
// Interface: ICOMCustomer7
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {748101FD-E76D-4331-82F1-FADAEF30E3EF}
// *********************************************************************//
  ICOMCustomer7 = interface(ICOMCustomer6)
    ['{748101FD-E76D-4331-82F1-FADAEF30E3EF}']
    ...
    property acSubType: WideString read Get_acSubType;
    property acLongACCode: WideString read Get_acLongACCode write Set_acLongACCode;
  end;

// *********************************************************************//
// DispIntf:  ICOMCustomer7Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {748101FD-E76D-4331-82F1-FADAEF30E3EF}
// *********************************************************************//
  ICOMCustomer7Disp = dispinterface
    ['{748101FD-E76D-4331-82F1-FADAEF30E3EF}']
    property acSubType: WideString readonly dispid 85;
    property acLongACCode: WideString dispid 86;
    property acDeliveryPostCode: WideString dispid 84;
    property acBankSortCode: WideString dispid 80;
    property acBankAccountCode: WideString dispid 81;
    property acMandateID: WideString dispid 82;
...
// *********************************************************************//
// Interface: ICOMSetup11
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {A2BC5F81-3827-4996-9402-344F4F170A3E}
// *********************************************************************//
  ICOMSetup11 = interface(ICOMSetup10)
    ['{A2BC5F81-3827-4996-9402-344F4F170A3E}']
    function Get_ssConsumersEnabled: WordBool; safecall;
    property ssConsumersEnabled: WordBool read Get_ssConsumersEnabled;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetup11Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {A2BC5F81-3827-4996-9402-344F4F170A3E}
// *********************************************************************//
  ICOMSetup11Disp = dispinterface
    ['{A2BC5F81-3827-4996-9402-344F4F170A3E}']
    property ssConsumersEnabled: WordBool readonly dispid 121;
    property ssBankAccountCode: WideString readonly dispid 119;
    property ssBankSortCode: WideString readonly dispid 120;
    property ssEnableOverrideLocation: WordBool readonly dispid 118;
    property ssCompanyCode: WideString readonly dispid 117;
...
// *********************************************************************//
// Interface: ICOMStock6
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {70E54971-A194-41BC-9EDD-E11001AD1FE5}
// *********************************************************************//
  ICOMStock6 = interface(ICOMStock5)
    ['{70E54971-A194-41BC-9EDD-E11001AD1FE5}']
    function Get_stIsService: WordBool; safecall;
    procedure Set_stIsService(Value: WordBool); safecall;
    property stIsService: WordBool read Get_stIsService write Set_stIsService;
  end;

// *********************************************************************//
// DispIntf:  ICOMStock6Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {70E54971-A194-41BC-9EDD-E11001AD1FE5}
// *********************************************************************//
  ICOMStock6Disp = dispinterface
    ['{70E54971-A194-41BC-9EDD-E11001AD1FE5}']
    property stIsService: WordBool dispid 113;
    property stStkUser5: WideString dispid 107;
    property stStkUser6: WideString dispid 108;
    property stStkUser7: WideString dispid 109;
    property stStkUser8: WideString dispid 110;
...
// *********************************************************************//
// Interface: ICOMTransaction10
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {32F6F0FE-CBA5-4FDB-986B-36FA9753F5E1}
// *********************************************************************//
  ICOMTransaction10 = interface(ICOMTransaction9)
    ['{32F6F0FE-CBA5-4FDB-986B-36FA9753F5E1}']
    ...
    property thPPDTakenStatus: TTransactionPPDTakenStatus read Get_thPPDTakenStatus write Set_thPPDTakenStatus;
    property thPPDCreditNote: WordBool read Get_thPPDCreditNote write Set_thPPDCreditNote;
    property thBatchPayPPDStatus: Integer read Get_thBatchPayPPDStatus write Set_thBatchPayPPDStatus;
  end;

// *********************************************************************//
// DispIntf:  ICOMTransaction10Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {32F6F0FE-CBA5-4FDB-986B-36FA9753F5E1}
// *********************************************************************//
  ICOMTransaction10Disp = dispinterface
    ['{32F6F0FE-CBA5-4FDB-986B-36FA9753F5E1}']
    property thPPDPercentage: Double dispid 107;
    property thPPDDays: Smallint dispid 108;
    property thPPDGoodsValue: Double dispid 109;
    property thPPDVATValue: Double dispid 110;
    property thPPDTakenStatus: TTransactionPPDTakenStatus dispid 111;
    property thPPDCreditNote: WordBool dispid 112;
    property thBatchPayPPDStatus: Integer dispid 113;
    property thDeliveryPostCode: WideString dispid 99;
    property thOriginator: WideString dispid 104;
    property thCreationTime: WideString dispid 105;
    property thCreationDate: WideString dispid 106;
...
// *********************************************************************//
// Interface: ICOMCustomer8
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {4F481185-B342-4FE6-A3EF-918A456B1A36}
// *********************************************************************//
  ICOMCustomer8 = interface(ICOMCustomer7)
    ['{4F481185-B342-4FE6-A3EF-918A456B1A36}']
    function Get_acPPDMode: TCustomerPPDMode; safecall;
    procedure Set_acPPDMode(Value: TCustomerPPDMode); safecall;
    property acPPDMode: TCustomerPPDMode read Get_acPPDMode write Set_acPPDMode;
  end;

// *********************************************************************//
// DispIntf:  ICOMCustomer8Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {4F481185-B342-4FE6-A3EF-918A456B1A36}
// *********************************************************************//
  ICOMCustomer8Disp = dispinterface
    ['{4F481185-B342-4FE6-A3EF-918A456B1A36}']
    property acPPDMode: TCustomerPPDMode dispid 87;
    property acSubType: WideString readonly dispid 85;
    property acLongACCode: WideString dispid 86;
    property acDeliveryPostCode: WideString dispid 84;
    property acBankSortCode: WideString dispid 80;
...
// *********************************************************************//
// Interface: ICOMCustomer9
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {3470014F-9581-44CE-B1FB-A0865DD2274A}
// *********************************************************************//
  ICOMCustomer9 = interface(ICOMCustomer8)
    ['{3470014F-9581-44CE-B1FB-A0865DD2274A}']
    ...
    property acAllowOrderPayments: WordBool read Get_acAllowOrderPayments write Set_acAllowOrderPayments;
    property acOrderPaymentsGLCode: Integer read Get_acOrderPaymentsGLCode write Set_acOrderPaymentsGLCode;
    property acCountry: WideString read Get_acCountry write Set_acCountry;
    property acDeliveryCountry: WideString read Get_acDeliveryCountry write Set_acDeliveryCountry;
  end;

// *********************************************************************//
// DispIntf:  ICOMCustomer9Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {3470014F-9581-44CE-B1FB-A0865DD2274A}
// *********************************************************************//
  ICOMCustomer9Disp = dispinterface
    ['{3470014F-9581-44CE-B1FB-A0865DD2274A}']
    property acAllowOrderPayments: WordBool dispid 88;
    property acOrderPaymentsGLCode: Integer dispid 89;
    property acCountry: WideString dispid 90;
    property acDeliveryCountry: WideString dispid 91;
    property acPPDMode: TCustomerPPDMode dispid 87;
    property acSubType: WideString readonly dispid 85;
    property acLongACCode: WideString dispid 86;
    property acDeliveryPostCode: WideString dispid 84;
...
// *********************************************************************//
// Interface: ICOMTransaction11
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {A84A57DC-655C-410A-96FE-A63C668A0D16}
// *********************************************************************//
  ICOMTransaction11 = interface(ICOMTransaction10)
    ['{A84A57DC-655C-410A-96FE-A63C668A0D16}']
    ...
    property thOrderPaymentOrderRef: WideString read Get_thOrderPaymentOrderRef;
    property thOrderPaymentElement: TTransactionOrderPaymentElement read Get_thOrderPaymentElement;
    property thOrderPaymentFlags: Integer read Get_thOrderPaymentFlags;
    property thCreditCardType: WideString read Get_thCreditCardType write Set_thCreditCardType;
    property thCreditCardNumber: WideString read Get_thCreditCardNumber write Set_thCreditCardNumber;
    property thCreditCardExpiry: WideString read Get_thCreditCardExpiry write Set_thCreditCardExpiry;
    property thCreditCardAuthorisationNo: WideString read Get_thCreditCardAuthorisationNo write Set_thCreditCardAuthorisationNo;
    property thCreditCardReferenceNo: WideString read Get_thCreditCardReferenceNo write Set_thCreditCardReferenceNo;
    property thCustomData1: WideString read Get_thCustomData1 write Set_thCustomData1;
    property thDeliveryCountry: WideString read Get_thDeliveryCountry write Set_thDeliveryCountry;
  end;

// *********************************************************************//
// DispIntf:  ICOMTransaction11Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {A84A57DC-655C-410A-96FE-A63C668A0D16}
// *********************************************************************//
  ICOMTransaction11Disp = dispinterface
    ['{A84A57DC-655C-410A-96FE-A63C668A0D16}']
    property thOrderPaymentOrderRef: WideString readonly dispid 114;
    property thOrderPaymentElement: TTransactionOrderPaymentElement readonly dispid 115;
    property thOrderPaymentFlags: Integer readonly dispid 116;
    property thCreditCardType: WideString dispid 117;
    property thCreditCardNumber: WideString dispid 118;
    property thCreditCardExpiry: WideString dispid 119;
    property thCreditCardAuthorisationNo: WideString dispid 120;
    property thCreditCardReferenceNo: WideString dispid 121;
    property thCustomData1: WideString dispid 122;
    property thDeliveryCountry: WideString dispid 123;
    property thPPDPercentage: Double dispid 107;
    property thPPDDays: Smallint dispid 108;
    property thPPDGoodsValue: Double dispid 109;
    property thPPDVATValue: Double dispid 110;
...
// *********************************************************************//
// Interface: ICOMTelesales3
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {A55ECCD8-B7EA-408B-8C84-42290F8C8E84}
// *********************************************************************//
  ICOMTelesales3 = interface(ICOMTeleSales2)
    ['{A55ECCD8-B7EA-408B-8C84-42290F8C8E84}']
    function Get_teDeliveryCountry: WideString; safecall;
    procedure Set_teDeliveryCountry(const Value: WideString); safecall;
    property teDeliveryCountry: WideString read Get_teDeliveryCountry write Set_teDeliveryCountry;
  end;

// *********************************************************************//
// DispIntf:  ICOMTelesales3Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {A55ECCD8-B7EA-408B-8C84-42290F8C8E84}
// *********************************************************************//
  ICOMTelesales3Disp = dispinterface
    ['{A55ECCD8-B7EA-408B-8C84-42290F8C8E84}']
    property teDeliveryCountry: WideString dispid 36;
    property teDeliveryPostCode: WideString dispid 35;
    property teCustCode: WideString dispid 1;
    property teCurrency: Integer dispid 2;
    property teCompanyRate: Double dispid 3;
...
// *********************************************************************//
// Interface: ICOMSetupUserFields5
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7F0E8B41-2551-4330-9DD1-84BCEB6A8F37}
// *********************************************************************//
  ICOMSetupUserFields5 = interface(IDispatch)
    ['{7F0E8B41-2551-4330-9DD1-84BCEB6A8F37}']
    ...
    property ufAddressDesc[FieldNo: Integer]: WideString read Get_ufAddressDesc;
    property ufCustDescEnabled[FieldNo: Integer]: WordBool read Get_ufCustDescEnabled;
    property ufSuppDescEnabled[FieldNo: Integer]: WordBool read Get_ufSuppDescEnabled;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetupUserFields5Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7F0E8B41-2551-4330-9DD1-84BCEB6A8F37}
// *********************************************************************//
  ICOMSetupUserFields5Disp = dispinterface
    ['{7F0E8B41-2551-4330-9DD1-84BCEB6A8F37}']
    property ufAddressDesc[FieldNo: Integer]: WideString readonly dispid 110;
    property ufCustDescEnabled[FieldNo: Integer]: WordBool readonly dispid 111;
    property ufSuppDescEnabled[FieldNo: Integer]: WordBool readonly dispid 112;
  end;

// *********************************************************************//
// Interface: ICOMSetup12
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7C2C2E9C-438D-426B-9293-14F186253A2D}
// *********************************************************************//
  ICOMSetup12 = interface(ICOMSetup11)
    ['{7C2C2E9C-438D-426B-9293-14F186253A2D}']
    function Get_ssOrderPaymentsEnabled: WordBool; safecall;
    property ssOrderPaymentsEnabled: WordBool read Get_ssOrderPaymentsEnabled;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetup12Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7C2C2E9C-438D-426B-9293-14F186253A2D}
// *********************************************************************//
  ICOMSetup12Disp = dispinterface
    ['{7C2C2E9C-438D-426B-9293-14F186253A2D}']
    property ssOrderPaymentsEnabled: WordBool readonly dispid 122;
    property ssConsumersEnabled: WordBool readonly dispid 121;
    property ssBankAccountCode: WideString readonly dispid 119;
    property ssBankSortCode: WideString readonly dispid 120;
    property ssEnableOverrideLocation: WordBool readonly dispid 118;
...
// *********************************************************************//
// Interface: ICOMCustomer10
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {B5ED1039-7EBD-4A55-9DB8-BB4482E9978C}
// *********************************************************************//
  ICOMCustomer10 = interface(ICOMCustomer9)
    ['{B5ED1039-7EBD-4A55-9DB8-BB4482E9978C}']
    function Get_acDefaultToQR: WordBool; safecall;
    procedure Set_acDefaultToQR(Value: WordBool); safecall;
    property acDefaultToQR: WordBool read Get_acDefaultToQR write Set_acDefaultToQR;
  end;

// *********************************************************************//
// DispIntf:  ICOMCustomer10Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {B5ED1039-7EBD-4A55-9DB8-BB4482E9978C}
// *********************************************************************//
  ICOMCustomer10Disp = dispinterface
    ['{B5ED1039-7EBD-4A55-9DB8-BB4482E9978C}']
    property acDefaultToQR: WordBool dispid 92;
    property acAllowOrderPayments: WordBool dispid 88;
    property acOrderPaymentsGLCode: Integer dispid 89;
    property acCountry: WideString dispid 90;
    property acDeliveryCountry: WideString dispid 91;
...
// *********************************************************************//
// Interface: ICOMTransaction12
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {38E8BC42-5D99-4D05-9763-47DCBC5325BF}
// *********************************************************************//
  ICOMTransaction12 = interface(ICOMTransaction11)
    ['{38E8BC42-5D99-4D05-9763-47DCBC5325BF}']
    function Get_thIntrastatOutOfPeriod: WordBool; safecall;
    procedure Set_thIntrastatOutOfPeriod(Value: WordBool); safecall;
    property thIntrastatOutOfPeriod: WordBool read Get_thIntrastatOutOfPeriod write Set_thIntrastatOutOfPeriod;
  end;

// *********************************************************************//
// DispIntf:  ICOMTransaction12Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {38E8BC42-5D99-4D05-9763-47DCBC5325BF}
// *********************************************************************//
  ICOMTransaction12Disp = dispinterface
    ['{38E8BC42-5D99-4D05-9763-47DCBC5325BF}']
    property thIntrastatOutOfPeriod: WordBool dispid 124;
    property thOrderPaymentOrderRef: WideString readonly dispid 114;
    property thOrderPaymentElement: TTransactionOrderPaymentElement readonly dispid 115;
    property thOrderPaymentFlags: Integer readonly dispid 116;
    property thCreditCardType: WideString dispid 117;
...
// *********************************************************************//
// Interface: ICOMTransactionLine10
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D69C0F34-EF96-4B1D-A158-A2B3232AE0CE}
// *********************************************************************//
  ICOMTransactionLine10 = interface(ICOMTransactionLine9)
    ['{D69C0F34-EF96-4B1D-A158-A2B3232AE0CE}']
    ...
    property tlIntrastatOverride: WordBool read Get_tlIntrastatOverride write Set_tlIntrastatOverride;
    property tlIntrastatCommodityCode: WideString read Get_tlIntrastatCommodityCode write Set_tlIntrastatCommodityCode;
    property tlIntrastatStockUnits: Double read Get_tlIntrastatStockUnits write Set_tlIntrastatStockUnits;
    property tlIntrastatCountry: WideString read Get_tlIntrastatCountry write Set_tlIntrastatCountry;
    property tlIntrastatNoTC: WideString read Get_tlIntrastatNoTC write Set_tlIntrastatNoTC;
    property tlIntrastatUplift: Double read Get_tlIntrastatUplift write Set_tlIntrastatUplift;
  end;

// *********************************************************************//
// DispIntf:  ICOMTransactionLine10Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D69C0F34-EF96-4B1D-A158-A2B3232AE0CE}
// *********************************************************************//
  ICOMTransactionLine10Disp = dispinterface
    ['{D69C0F34-EF96-4B1D-A158-A2B3232AE0CE}']
    property tlIntrastatOverride: WordBool dispid 107;
    property tlIntrastatCommodityCode: WideString dispid 108;
    property tlIntrastatStockUnits: Double dispid 109;
    property tlIntrastatCountry: WideString dispid 110;
    property tlIntrastatNoTC: WideString dispid 111;
    property tlIntrastatUplift: Double dispid 112;
    property tlUserDef5: WideString dispid 87;
    property tlUserDef6: WideString dispid 88;
    property tlUserDef7: WideString dispid 89;
    property tlUserDef8: WideString dispid 90;
...
// *********************************************************************//
// Interface: ICOMTelesales4
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {DCCE805C-4142-42ED-A27F-445B77A03B6C}
// *********************************************************************//
  ICOMTelesales4 = interface(ICOMTelesales3)
    ['{DCCE805C-4142-42ED-A27F-445B77A03B6C}']
    function Get_teSSDProcess: WideString; safecall;
    procedure Set_teSSDProcess(const Value: WideString); safecall;
    property teSSDProcess: WideString read Get_teSSDProcess write Set_teSSDProcess;
  end;

// *********************************************************************//
// DispIntf:  ICOMTelesales4Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {DCCE805C-4142-42ED-A27F-445B77A03B6C}
// *********************************************************************//
  ICOMTelesales4Disp = dispinterface
    ['{DCCE805C-4142-42ED-A27F-445B77A03B6C}']
    property teSSDProcess: WideString dispid 37;
    property teDeliveryCountry: WideString dispid 36;
    property teDeliveryPostCode: WideString dispid 35;
    property teCustCode: WideString dispid 1;
    property teCurrency: Integer dispid 2;
...
// *********************************************************************//
// Interface: ICOMTransaction13
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {722D5C91-36E2-4137-9385-DC700E375155}
// *********************************************************************//
  ICOMTransaction13 = interface(ICOMTransaction12)
    ['{722D5C91-36E2-4137-9385-DC700E375155}']
    ...
    property thUser11: WideString read Get_thUser11 write Set_thUser11;
    property thUser12: WideString read Get_thUser12 write Set_thUser12;
  end;

// *********************************************************************//
// DispIntf:  ICOMTransaction13Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {722D5C91-36E2-4137-9385-DC700E375155}
// *********************************************************************//
  ICOMTransaction13Disp = dispinterface
    ['{722D5C91-36E2-4137-9385-DC700E375155}']
    property thUser11: WideString dispid 125;
    property thUser12: WideString dispid 126;
    property thIntrastatOutOfPeriod: WordBool dispid 124;
    property thOrderPaymentOrderRef: WideString readonly dispid 114;
    property thOrderPaymentElement: TTransactionOrderPaymentElement readonly dispid 115;
    property thOrderPaymentFlags: Integer readonly dispid 116;
...
// *********************************************************************//
// Interface: IRCTGateway
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {A80E29BF-B6CE-455B-9F37-AF4ACB5046DA}
// *********************************************************************//
  IRCTGateway = interface(IDispatch)
    ['{A80E29BF-B6CE-455B-9F37-AF4ACB5046DA}']
    function TagTransaction(const OurRef: WideString): Integer; safecall;
    function ProcessPayments: Integer; safecall;
    ...
    property BankGLCode: Integer read Get_BankGLCode write Set_BankGLCode;
    property GLControlAccount: Integer read Get_GLControlAccount write Set_GLControlAccount;
    property CostCentre: WideString read Get_CostCentre write Set_CostCentre;
    property Department: WideString read Get_Department write Set_Department;
    property UseAccountCCDept: WordBool read Get_UseAccountCCDept write Set_UseAccountCCDept;
    property InvoiceCurrency: Integer read Get_InvoiceCurrency write Set_InvoiceCurrency;
    property YourRef: WideString read Get_YourRef write Set_YourRef;
    property AgeBalancesBy: TBatchAgeType read Get_AgeBalancesBy write Set_AgeBalancesBy;
    property AgeInterval: Integer read Get_AgeInterval write Set_AgeInterval;
    property IncludeSettlementDiscount: WordBool read Get_IncludeSettlementDiscount write Set_IncludeSettlementDiscount;
    property PPDExpiryTolerance: Integer read Get_PPDExpiryTolerance write Set_PPDExpiryTolerance;
    property PaymentType: WideString read Get_PaymentType write Set_PaymentType;
    property PaymentCurrency: Integer read Get_PaymentCurrency write Set_PaymentCurrency;
    property UseChequePrinting: WordBool read Get_UseChequePrinting write Set_UseChequePrinting;
    property ChequeNumber: Integer read Get_ChequeNumber write Set_ChequeNumber;
    property ApplyPPD: WordBool read Get_ApplyPPD write Set_ApplyPPD;
    property PPDPaymentDate: WideString read Get_PPDPaymentDate write Set_PPDPaymentDate;
    property DaysOverSettlementDiscount: Integer read Get_DaysOverSettlementDiscount write Set_DaysOverSettlementDiscount;
    property CompanyCode: WideString read Get_CompanyCode;
    property UserID: WideString read Get_UserID;
  end;

// *********************************************************************//
// DispIntf:  IRCTGatewayDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {A80E29BF-B6CE-455B-9F37-AF4ACB5046DA}
// *********************************************************************//
  IRCTGatewayDisp = dispinterface
    ['{A80E29BF-B6CE-455B-9F37-AF4ACB5046DA}']
    function TagTransaction(const OurRef: WideString): Integer; dispid 3;
    function ProcessPayments: Integer; dispid 4;
    property BankGLCode: Integer dispid 1;
    property GLControlAccount: Integer dispid 2;
    property CostCentre: WideString dispid 5;
    property Department: WideString dispid 6;
    property UseAccountCCDept: WordBool dispid 7;
    property InvoiceCurrency: Integer dispid 8;
    property YourRef: WideString dispid 9;
    property AgeBalancesBy: TBatchAgeType dispid 10;
    property AgeInterval: Integer dispid 11;
    property IncludeSettlementDiscount: WordBool dispid 12;
    property PPDExpiryTolerance: Integer dispid 13;
    property PaymentType: WideString dispid 14;
    property PaymentCurrency: Integer dispid 15;
    property UseChequePrinting: WordBool dispid 16;
    property ChequeNumber: Integer dispid 17;
    property ApplyPPD: WordBool dispid 18;
    property PPDPaymentDate: WideString dispid 19;
    property DaysOverSettlementDiscount: Integer dispid 20;
    property CompanyCode: WideString readonly dispid 21;
    property UserID: WideString readonly dispid 22;
  end;

// *********************************************************************//
// Interface: IRCTPlugin
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {C161DE1B-CA50-44FF-8C76-B0CADF69AFF2}
// *********************************************************************//
  IRCTPlugin = interface(IDispatch)
    ['{C161DE1B-CA50-44FF-8C76-B0CADF69AFF2}']
    function Process(const Gateway: IRCTGateway): WordBool; safecall;
    function Get_MenuCaption: WideString; safecall;
    function Start(const Gateway: IRCTGateway): WordBool; safecall;
    procedure Finish(const Gateway: IRCTGateway); safecall;
    function OnHeaderError(const Gateway: IRCTGateway; StatusCode: TRCTStatusCode; 
                           const Description: WideString): WordBool; safecall;
    property MenuCaption: WideString read Get_MenuCaption;
  end;

// *********************************************************************//
// DispIntf:  IRCTPluginDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {C161DE1B-CA50-44FF-8C76-B0CADF69AFF2}
// *********************************************************************//
  IRCTPluginDisp = dispinterface
    ['{C161DE1B-CA50-44FF-8C76-B0CADF69AFF2}']
    function Process(const Gateway: IRCTGateway): WordBool; dispid 1;
    property MenuCaption: WideString readonly dispid 2;
    function Start(const Gateway: IRCTGateway): WordBool; dispid 3;
    procedure Finish(const Gateway: IRCTGateway); dispid 4;
    function OnHeaderError(const Gateway: IRCTGateway; StatusCode: TRCTStatusCode; 
                           const Description: WideString): WordBool; dispid 5;
  end;

// *********************************************************************//
// Interface: ICOMSetupUserFields6
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {BBA44BC8-DA42-4A4B-961C-2E5F6CC6696A}
// *********************************************************************//
  ICOMSetupUserFields6 = interface(ICOMSetupUserFields4)
    ['{BBA44BC8-DA42-4A4B-961C-2E5F6CC6696A}']
    function Get_ufAddressDesc(FieldNo: Integer): WideString; safecall;
    function Get_ufCustDescEnabled(FieldNo: Integer): WordBool; safecall;
    function Get_ufSuppDescEnabled(FieldNo: Integer): WordBool; safecall;
    property ufAddressDesc[FieldNo: Integer]: WideString read Get_ufAddressDesc;
...
// *********************************************************************//
// DispIntf:  ICOMSetupUserFields6Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {BBA44BC8-DA42-4A4B-961C-2E5F6CC6696A}
// *********************************************************************//
  ICOMSetupUserFields6Disp = dispinterface
...
// *********************************************************************//
// Interface: ICOMUserProfile4
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D8E9F694-A4C6-4989-8905-8359A39EA7EA}
// *********************************************************************//
  ICOMUserProfile4 = interface(ICOMUserProfile3)
    ['{D8E9F694-A4C6-4989-8905-8359A39EA7EA}']
    function Get_upWindowsUserID: WideString; safecall;
    procedure Set_upWindowsUserID(const Value: WideString); safecall;
    property upWindowsUserID: WideString read Get_upWindowsUserID write Set_upWindowsUserID;
  end;

// *********************************************************************//
// DispIntf:  ICOMUserProfile4Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D8E9F694-A4C6-4989-8905-8359A39EA7EA}
// *********************************************************************//
  ICOMUserProfile4Disp = dispinterface
    ['{D8E9F694-A4C6-4989-8905-8359A39EA7EA}']
    property upWindowsUserID: WideString dispid 25;
    property upShowProductTypesInTree: WordBool readonly dispid 23;
    property upShowStockCodesInTree: WordBool readonly dispid 24;
    property upShowGLCodesInTree: WordBool readonly dispid 1;
    property upUserId: WideString readonly dispid 2;
...
// *********************************************************************//
// Interface: ICOMCustomer11
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D955C0DD-4CA1-41AC-A28C-83256C157B8A}
// *********************************************************************//
  ICOMCustomer11 = interface(ICOMCustomer10)
    ['{D955C0DD-4CA1-41AC-A28C-83256C157B8A}']
    function Get_acAnonymisationStatus: TEntityAnonymisationStatus; safecall;
    procedure Set_acAnonymisationStatus(Value: TEntityAnonymisationStatus); safecall;
    ...
    property acAnonymisationStatus: TEntityAnonymisationStatus read Get_acAnonymisationStatus write Set_acAnonymisationStatus;
    property acAnonymisedDate: WideString read Get_acAnonymisedDate write Set_acAnonymisedDate;
    property acAnonymisedTime: WideString read Get_acAnonymisedTime write Set_acAnonymisedTime;
  end;

// *********************************************************************//
// DispIntf:  ICOMCustomer11Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {D955C0DD-4CA1-41AC-A28C-83256C157B8A}
// *********************************************************************//
  ICOMCustomer11Disp = dispinterface
    ['{D955C0DD-4CA1-41AC-A28C-83256C157B8A}']
    property acAnonymisationStatus: TEntityAnonymisationStatus dispid 93;
    property acAnonymisedDate: WideString dispid 94;
    property acAnonymisedTime: WideString dispid 95;
    property acDefaultToQR: WordBool dispid 92;
    property acAllowOrderPayments: WordBool dispid 88;
    property acOrderPaymentsGLCode: Integer dispid 89;
    property acCountry: WideString dispid 90;
...
// *********************************************************************//
// Interface: ICOMUserProfile5
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7CF61572-7297-4ABA-A607-4DF0BC71E9DA}
// *********************************************************************//
  ICOMUserProfile5 = interface(ICOMUserProfile4)
    ['{7CF61572-7297-4ABA-A607-4DF0BC71E9DA}']
    ...
    property upHighlightPIIFields: WordBool read Get_upHighlightPIIFields write Set_upHighlightPIIFields;
    property upHighlighPIIColour: Integer read Get_upHighlighPIIColour write Set_upHighlighPIIColour;
  end;

// *********************************************************************//
// DispIntf:  ICOMUserProfile5Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7CF61572-7297-4ABA-A607-4DF0BC71E9DA}
// *********************************************************************//
  ICOMUserProfile5Disp = dispinterface
    ['{7CF61572-7297-4ABA-A607-4DF0BC71E9DA}']
    property upHighlightPIIFields: WordBool dispid 26;
    property upHighlighPIIColour: Integer dispid 27;
    property upWindowsUserID: WideString dispid 25;
    property upShowProductTypesInTree: WordBool readonly dispid 23;
    property upShowStockCodesInTree: WordBool readonly dispid 24;
    property upShowGLCodesInTree: WordBool readonly dispid 1;
...
// *********************************************************************//
// Interface: ICOMTransaction14
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {3A5E60B1-3A11-4146-8541-44D912E94E8E}
// *********************************************************************//
  ICOMTransaction14 = interface(ICOMTransaction13)
    ['{3A5E60B1-3A11-4146-8541-44D912E94E8E}']
    ...
    property thAnonymised: WordBool read Get_thAnonymised write Set_thAnonymised;
    property thAnonymisedDate: WideString read Get_thAnonymisedDate write Set_thAnonymisedDate;
    property thAnonymisedTime: WideString read Get_thAnonymisedTime write Set_thAnonymisedTime;
  end;

// *********************************************************************//
// DispIntf:  ICOMTransaction14Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {3A5E60B1-3A11-4146-8541-44D912E94E8E}
// *********************************************************************//
  ICOMTransaction14Disp = dispinterface
    ['{3A5E60B1-3A11-4146-8541-44D912E94E8E}']
    property thAnonymised: WordBool dispid 127;
    property thAnonymisedDate: WideString dispid 128;
    property thAnonymisedTime: WideString dispid 129;
    property thUser11: WideString dispid 125;
    property thUser12: WideString dispid 126;
    property thIntrastatOutOfPeriod: WordBool dispid 124;
    property thOrderPaymentOrderRef: WideString readonly dispid 114;
...
// *********************************************************************//
// Interface: ICOMEmployee5
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7A9C051D-95BF-40DA-BDEE-1A87103807C5}
// *********************************************************************//
  ICOMEmployee5 = interface(ICOMEmployee4)
    ['{7A9C051D-95BF-40DA-BDEE-1A87103807C5}']
    function Get_emStatus: TEmployeeStatus; safecall;
    procedure Set_emStatus(Value: TEmployeeStatus); safecall;
    function Get_emAnonymisationStatus: TEntityAnonymisationStatus; safecall;
    procedure Set_emAnonymisationStatus(Value: TEntityAnonymisationStatus); safecall;
    ...
    property emStatus: TEmployeeStatus read Get_emStatus write Set_emStatus;
    property emAnonymisationStatus: TEntityAnonymisationStatus read Get_emAnonymisationStatus write Set_emAnonymisationStatus;
    property emAnonymisedDate: WideString read Get_emAnonymisedDate write Set_emAnonymisedDate;
    property emAnonymisedTime: WideString read Get_emAnonymisedTime write Set_emAnonymisedTime;
  end;

// *********************************************************************//
// DispIntf:  ICOMEmployee5Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {7A9C051D-95BF-40DA-BDEE-1A87103807C5}
// *********************************************************************//
  ICOMEmployee5Disp = dispinterface
    ['{7A9C051D-95BF-40DA-BDEE-1A87103807C5}']
    property emStatus: TEmployeeStatus dispid 31;
    property emAnonymisationStatus: TEntityAnonymisationStatus dispid 32;
    property emAnonymisedDate: WideString dispid 33;
    property emAnonymisedTime: WideString dispid 34;
    property emContractorType: Integer dispid 26;
    property emTagged: Integer dispid 27;
    property emTimeRateRules: Integer dispid 28;
    property emUTRCode: WideString dispid 29;
...
// *********************************************************************//
// Interface: ICOMSetup13
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {EC61ACD2-72D6-43C7-9D0E-17393186EEB8}
// *********************************************************************//
  ICOMSetup13 = interface(ICOMSetup12)
    ['{EC61ACD2-72D6-43C7-9D0E-17393186EEB8}']
    function Get_ssCurrencyImportTolerance: Single; safecall;
    property ssCurrencyImportTolerance: Single read Get_ssCurrencyImportTolerance;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetup13Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {EC61ACD2-72D6-43C7-9D0E-17393186EEB8}
// *********************************************************************//
  ICOMSetup13Disp = dispinterface
    ['{EC61ACD2-72D6-43C7-9D0E-17393186EEB8}']
    property ssCurrencyImportTolerance: Single readonly dispid 123;
    property ssOrderPaymentsEnabled: WordBool readonly dispid 122;
    property ssConsumersEnabled: WordBool readonly dispid 121;
    property ssBankAccountCode: WideString readonly dispid 119;
    property ssBankSortCode: WideString readonly dispid 120;
...
// *********************************************************************//
// Interface: ICOMSetupGDPR
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {4648D17C-BB71-4332-8EFA-D72D72311D78}
// *********************************************************************//
  ICOMSetupGDPR = interface(IDispatch)
    ['{4648D17C-BB71-4332-8EFA-D72D72311D78}']
    ...
    property Anonymised: WordBool read Get_Anonymised;
    property AnonymisedDate: WideString read Get_AnonymisedDate;
    property AnonymisedTime: WideString read Get_AnonymisedTime;
    property GDPRTraderRetentionPeriod: Integer read Get_GDPRTraderRetentionPeriod;
    property GDPRTraderDisplayPIITree: WordBool read Get_GDPRTraderDisplayPIITree;
    property GDPRTraderAnonNotesOption: Integer read Get_GDPRTraderAnonNotesOption;
    property GDPRTraderAnonLettersOption: Integer read Get_GDPRTraderAnonLettersOption;
    property GDPRTraderAnonLinksOption: Integer read Get_GDPRTraderAnonLinksOption;
    property GDPREmployeeRetentionPeriod: Integer read Get_GDPREmployeeRetentionPeriod;
    property GDPREmployeeDisplayPIITree: WordBool read Get_GDPREmployeeDisplayPIITree;
    property GDPREmployeeAnonNotesOption: Integer read Get_GDPREmployeeAnonNotesOption;
    property GDPREmployeeAnonLettersOption: Integer read Get_GDPREmployeeAnonLettersOption;
    property GDPREmployeeAnonLinksOption: Integer read Get_GDPREmployeeAnonLinksOption;
    property NotificationWarningColour: Integer read Get_NotificationWarningColour;
    property NotificationWarningFontColour: Integer read Get_NotificationWarningFontColour;
    property GDPRCompanyAnonLocations: WordBool read Get_GDPRCompanyAnonLocations;
    property GDPRCompanyAnonCostCentres: WordBool read Get_GDPRCompanyAnonCostCentres;
    property GDPRCompanyAnonDepartment: WordBool read Get_GDPRCompanyAnonDepartment;
    property GDPRCompanyNotesOption: Integer read Get_GDPRCompanyNotesOption;
    property GDPRCompanyLettersOption: Integer read Get_GDPRCompanyLettersOption;
    property GDPRCompanyLinksOption: Integer read Get_GDPRCompanyLinksOption;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetupGDPRDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {4648D17C-BB71-4332-8EFA-D72D72311D78}
// *********************************************************************//
  ICOMSetupGDPRDisp = dispinterface
    ['{4648D17C-BB71-4332-8EFA-D72D72311D78}']
    property Anonymised: WordBool readonly dispid 124;
    property AnonymisedDate: WideString readonly dispid 125;
    property AnonymisedTime: WideString readonly dispid 126;
    property GDPRTraderRetentionPeriod: Integer readonly dispid 127;
    property GDPRTraderDisplayPIITree: WordBool readonly dispid 128;
    property GDPRTraderAnonNotesOption: Integer readonly dispid 129;
    property GDPRTraderAnonLettersOption: Integer readonly dispid 130;
    property GDPRTraderAnonLinksOption: Integer readonly dispid 131;
    property GDPREmployeeRetentionPeriod: Integer readonly dispid 132;
    property GDPREmployeeDisplayPIITree: WordBool readonly dispid 133;
    property GDPREmployeeAnonNotesOption: Integer readonly dispid 134;
    property GDPREmployeeAnonLettersOption: Integer readonly dispid 135;
    property GDPREmployeeAnonLinksOption: Integer readonly dispid 136;
    property NotificationWarningColour: Integer readonly dispid 137;
    property NotificationWarningFontColour: Integer readonly dispid 138;
    property GDPRCompanyAnonLocations: WordBool readonly dispid 139;
    property GDPRCompanyAnonCostCentres: WordBool readonly dispid 140;
    property GDPRCompanyAnonDepartment: WordBool readonly dispid 141;
    property GDPRCompanyNotesOption: Integer readonly dispid 142;
    property GDPRCompanyLettersOption: Integer readonly dispid 143;
    property GDPRCompanyLinksOption: Integer readonly dispid 144;
  end;

// *********************************************************************//
// Interface: ICOMSetup14
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {5E9DE5B1-0ACE-425B-BDD6-3E8CCB6D6D46}
// *********************************************************************//
  ICOMSetup14 = interface(ICOMSetup13)
    ['{5E9DE5B1-0ACE-425B-BDD6-3E8CCB6D6D46}']
    function Get_ssGDPR: ICOMSetupGDPR; safecall;
    property ssGDPR: ICOMSetupGDPR read Get_ssGDPR;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetup14Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {5E9DE5B1-0ACE-425B-BDD6-3E8CCB6D6D46}
// *********************************************************************//
  ICOMSetup14Disp = dispinterface
    ['{5E9DE5B1-0ACE-425B-BDD6-3E8CCB6D6D46}']
    property ssGDPR: ICOMSetupGDPR readonly dispid 125;
    property ssCurrencyImportTolerance: Single readonly dispid 123;
    property ssOrderPaymentsEnabled: WordBool readonly dispid 122;
    property ssConsumersEnabled: WordBool readonly dispid 121;
    property ssBankAccountCode: WideString readonly dispid 119;
...
// Interface: ICOMJob5
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {58463F30-F7F3-4A1C-BAFE-BF3B22D12F28}
// *********************************************************************//
  ICOMJob5 = interface(ICOMJob4)
    ['{58463F30-F7F3-4A1C-BAFE-BF3B22D12F28}']
    ...
    property jrAnonymised: WordBool read Get_jrAnonymised;
    property jrAnonymisedDate: WideString read Get_jrAnonymisedDate;
    property jrAnonymisedTime: WideString read Get_jrAnonymisedTime;
  end;

// *********************************************************************//
// DispIntf:  ICOMJob5Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {58463F30-F7F3-4A1C-BAFE-BF3B22D12F28}
// *********************************************************************//
  ICOMJob5Disp = dispinterface
    ['{58463F30-F7F3-4A1C-BAFE-BF3B22D12F28}']
    property jrAnonymised: WordBool readonly dispid 40;
    property jrAnonymisedDate: WideString readonly dispid 41;
    property jrAnonymisedTime: WideString readonly dispid 42;
    property jrUserDef5: WideString dispid 34;
    property jrUserDef6: WideString dispid 35;
    property jrUserDef7: WideString dispid 36;
    property jrUserDef8: WideString dispid 37;
...
// *********************************************************************//
// Interface: ICOMSetup15
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {C9CBD50D-EE4C-411D-ACCB-628084EB67CE}
// *********************************************************************//
  ICOMSetup15 = interface(ICOMSetup14)
    ['{C9CBD50D-EE4C-411D-ACCB-628084EB67CE}']
    function Get_ssConnectionString: WideString; safecall;
    function Get_ssConnectionPassword: WideString; safecall;
    property ssConnectionString: WideString read Get_ssConnectionString;
    property ssConnectionPassword: WideString read Get_ssConnectionPassword;
  end;

// *********************************************************************//
// DispIntf:  ICOMSetup15Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {C9CBD50D-EE4C-411D-ACCB-628084EB67CE}
// *********************************************************************//
  ICOMSetup15Disp = dispinterface
    ['{C9CBD50D-EE4C-411D-ACCB-628084EB67CE}']
    property ssConnectionString: WideString readonly dispid 124;
    property ssConnectionPassword: WideString readonly dispid 127;
    property ssGDPR: ICOMSetupGDPR readonly dispid 125;
    property ssCurrencyImportTolerance: Single readonly dispid 123;
    property ssOrderPaymentsEnabled: WordBool readonly dispid 122;
    property ssConsumersEnabled: WordBool readonly dispid 121;
...
// *********************************************************************//
// Interface: ICOMVersion2
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {F13C4582-BC8C-4376-879C-0B12F2DEAB8F}
// *********************************************************************//
  ICOMVersion2 = interface(ICOMVersion)
    ['{F13C4582-BC8C-4376-879C-0B12F2DEAB8F}']
    function Get_GDPROnLicense: WordBool; safecall;
    property GDPROnLicense: WordBool read Get_GDPROnLicense;
  end;

// *********************************************************************//
// DispIntf:  ICOMVersion2Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {F13C4582-BC8C-4376-879C-0B12F2DEAB8F}
// *********************************************************************//
  ICOMVersion2Disp = dispinterface
    ['{F13C4582-BC8C-4376-879C-0B12F2DEAB8F}']
    property GDPROnLicense: WordBool readonly dispid 2;
    property AcStkAnalOn: WordBool readonly dispid 5;
    property CurrencyVer: Smallint readonly dispid 3;
    property EBusinessOn: WordBool readonly dispid 6;
    property JobCostOn: WordBool readonly dispid 7;
...
// *********************************************************************//
// The Class CoVAT100_Callback provides a Create and CreateRemote method to          
// create instances of the default interface IVAT100_Callback exposed by              
// the CoClass VAT100_Callback. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoVAT100_Callback = class
    class function Create: IVAT100_Callback;
    class function CreateRemote(const MachineName: string): IVAT100_Callback;
  end;
...
class function CoVAT100_Callback.Create: IVAT100_Callback;
begin
  Result := CreateComObject(CLASS_VAT100_Callback) as IVAT100_Callback;
end;

class function CoVAT100_Callback.CreateRemote(const MachineName: string): IVAT100_Callback;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_VAT100_Callback) as IVAT100_Callback;
end;
