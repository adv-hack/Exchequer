object StockLevelsFrm: TStockLevelsFrm
  Left = 448
  Top = 205
  HelpContext = 719
  ...
  object PageControl1: TPageControl
    ...
    object StkLevelsPage: TTabSheet
      ...
      object Label2: TLabel
        ...
        AutoSize = False
        Caption = 
          'Note that the Stock Required and Need values take into account S' +
          'tock Items (including Bill of Material components) from other li' +
          'nes on this transaction.'
        WordWrap = True
      end
      ...
      object edtRequired: TCurrencyEdit
        Tag = 2
        Left = 294
        Top = 16
        Width = 80
    ...
    object BinPage: TTabSheet
      ...
      ImageIndex = 2
      object BinTree: TSBSOutlineB
        Left = 0
        Top = 0
        Width = 389
        Height = 176
        OnExpand = BinTreeExpand
        Options = []
        ItemHeight = 17
        ItemSpace = 8
    ...
    object EquivPage: TTabSheet
      Caption = 'Equivalents'
      ImageIndex = 3
      object EquivalentsTree: TSBSOutlineB
        Left = 0
        Top = 0
        Width = 299
        Height = 176
        ...
        Color = clWhite
        TabOrder = 0
        OnClick = EquivalentsTreeClick
        OnDblClick = EquivalentsTreeDblClick
        ItemSeparator = '\'
        PictureOpen.Data = {
