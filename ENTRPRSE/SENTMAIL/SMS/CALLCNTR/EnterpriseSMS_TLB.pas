...
// File generated on 07/02/2002 08:40:15 from Type Library described below.

// ************************************************************************  //
// Type Lib: X:\ENTRPRSE\SENTMAIL\SMS\CALLCNTR\SMSCALL.tlb (1)
...
// *********************************************************************//
  ISMSSenderDisp = dispinterface
    ...
    property Number: WideString dispid 12;
    property Message: WideString dispid 13;
    procedure Reset; dispid 2;
    function AreYouReady: WordBool; dispid 4;
  end;
