library ExchKonnect;
//PR: 14/02/2013 ABSEXCH-13581 v7.0.2 DLL for Konnect-It to backdoor the COM Toolkit for eXchequer 365.
uses
  SysUtils,
  Windows,
...
Procedure Konnect_CTKDebugMode (Var I1, I2, I3 : LongInt); StdCall;
Var
...
Begin
  ...
  If (ExeName = 'X365POLL') and ((I1 = 1955) And (I2 = 364759) And (I3 = -612498)) Then
  Begin
    I1 := 0;
    I2 := 0;
    I3 := 0;
    EncodeOpCode (124, I1, I2, I3);
  End { If I1... }
  Else Begin
