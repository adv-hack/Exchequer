...
begin
  ...
  begin
    ...
    begin;
      Result := GetDBColumnName('Ccdeptv', FieldNames[i].SQLName, '');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Commssn', FieldNames[i].SQLName, '');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Company', FieldNames[i].SQLName, 'C');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Company', FieldNames[i].SQLName, 'S');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Company', FieldNames[i].SQLName, 'U');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Company', FieldNames[i].SQLName, 'T');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Company', FieldNames[i].SQLName, 'R');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Company', FieldNames[i].SQLName, 'H');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Company', FieldNames[i].SQLName, 'A');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Contact', FieldNames[i].SQLName, 'A');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Details', FieldNames[i].SQLName, 'A');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Dictionary', FieldNames[i].SQLName, 'DV');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Dictionary', FieldNames[i].SQLName, 'DX');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Document', FieldNames[i].SQLName, '');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'EG');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'DG');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'EC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'EN');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'EI');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'EX');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'EA');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'EF');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'EE');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'ED');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'DC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'DY');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'EP');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Ebus', FieldNames[i].SQLName, 'EQ');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EBUSLKUP', FieldNames[i].SQLName, 'C');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EBUSLKUP', FieldNames[i].SQLName, 'V');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EBUSLKUP', FieldNames[i].SQLName, 'T');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EBUSNOTE', FieldNames[i].SQLName, 'ND');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Emppay', FieldNames[i].SQLName, 'ND');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'P*');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'L*');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'N*');
      Break;
    end;
  end;
end;
...
const
  ...
  FieldNames : Array[1..NumberOfFields] of TFieldName = (
                                                         ...
                                                         (SQLName:'exchqchk_code2';TKName:'EXCHQCHKcode2'),
                                                         (SQLName:'exchqchk_code3';TKName:'EXCHQCHKcode3'),
                                                         (SQLName:'settled_val';TKName:'SettledVal'),
                                                         (SQLName:'own_c_val';TKName:'OwnCVal'),
                                                         (SQLName:'m_currency';TKName:'MCurrency'),
                                                         (SQLName:'match_type';TKName:'MatchType'),
                                                         (SQLName:'old_alt_ref';TKName:'OldAltRef'),
                                                         (SQLName:'r_currency';TKName:'RCurrency'),
                                                         (SQLName:'rec_own_c_val';TKName:'RecOwnCVal'),
                                                         (SQLName:'alt_ref';TKName:'AltRef')
                                                        );
var
  i : integer;
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'T*');
      Break;
    end;
  end;
end;
...
const
  ...
  FieldNames : Array[1..NumberOfFields] of TFieldName = (
                                                         ...
                                                         (SQLName:'exchqchk_code2';TKName:'EXCHQCHKcode2'),
                                                         (SQLName:'exchqchk_code3';TKName:'EXCHQCHKcode3'),
                                                         (SQLName:'qty_used';TKName:'QtyUsed'),
                                                         (SQLName:'qty_cost';TKName:'QtyCost'),
                                                         (SQLName:'q_currency';TKName:'QCurrency'),
                                                         (SQLName:'full_stk_code';TKName:'FullStkCode'),
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'BM');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'XC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'MT');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'A*');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'C*');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'MN');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'MS');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'LV');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'XU');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqchk', FieldNames[i].SQLName, 'LM');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Exchqnum', FieldNames[i].SQLName, 'LM');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'SYS');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'VAT');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'Cur');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'DEF');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'JOB');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'FR*');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'MOD');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'GC*');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'ED1');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'ED2');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'ED3');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'CT*');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'CIS');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('ExchqSS', FieldNames[i].SQLName, 'CI2');
      Break;
    end;
  end;
end;
...
const
  ...
  FieldNames : Array[1..NumberOfFields] of TFieldName = (
                                                         ...
                                                         (SQLName:'cust_qb_type';TKName:'CustQBType'),
                                                         (SQLName:'cust_qb_curr';TKName:'CustQBCurr'),
                                                         (SQLName:'cust_qs_price';TKName:'CustQSPrice'),
                                                         (SQLName:'cust_q_band';TKName:'CustQBand'),
                                                         (SQLName:'cust_qdisc_p';TKName:'CustQDiscP'),
                                                         (SQLName:'cust_qdisc_a';TKName:'CustQDiscA'),
                                                         (SQLName:'cust_qmumg';TKName:'CustQMUMG'),
                                                         (SQLName:'cuse_dates';TKName:'CUseDates'),
                                                         (SQLName:'cstart_d';TKName:'CStartD'),
                                                         (SQLName:'cend_d';TKName:'CEndD')
                                                        );
var
  i : integer;
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'C*');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'PL');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'FS');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'AB');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'D*');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'XS');
      Break;
    end;
  end;
end;
...
const
  ...
  FieldNames : Array[1..NumberOfFields] of TFieldName = (
                                                         ...
                                                         (SQLName:'exstchk_var2';TKName:'exstchkvar2'),
                                                         (SQLName:'exstchk_var3';TKName:'exstchkvar3'),
                                                         (SQLName:'in_doc';TKName:'InDoc'),
                                                         (SQLName:'out_doc';TKName:'OutDoc'),
                                                         (SQLName:'sold';TKName:'Sold'),
                                                         (SQLName:'date_in';TKName:'DateIn'),
                                                         (SQLName:'ser_cost';TKName:'SerCost'),
                                                         (SQLName:'ser_sell';TKName:'SerSell'),
                                                         (SQLName:'stk_folio';TKName:'StkFolio'),
                                                         (SQLName:'date_out';TKName:'DateOut'),
                                                         (SQLName:'sold_line';TKName:'SoldLine'),
                                                         (SQLName:'cur_cost';TKName:'CurCost'),
                                                         (SQLName:'cur_sell';TKName:'CurSell'),
                                                         (SQLName:'buy_line';TKName:'BuyLine'),
                                                         (SQLName:'batch_rec';TKName:'BatchRec'),
                                                         (SQLName:'buy_qty';TKName:'BuyQty'),
                                                         (SQLName:'qty_used';TKName:'QtyUsed'),
                                                         (SQLName:'batch_child';TKName:'BatchChild'),
                                                         (SQLName:'in_mloc';TKName:'InMLoc'),
                                                         (SQLName:'out_mloc';TKName:'OutMLoc'),
                                                         (SQLName:'ser_c_rates1';TKName:'SerCompanyRate'),
                                                         (SQLName:'ser_c_rates2';TKName:'SerDailyRate'),
                                                         (SQLName:'in_ord_doc';TKName:'InOrdDoc'),
                                                         (SQLName:'out_ord_doc';TKName:'OutOrdDoc'),
                                                         (SQLName:'in_ord_line';TKName:'InOrdLine'),
                                                         (SQLName:'out_ord_line';TKName:'OutOrdLine'),
                                                         (SQLName:'n_line_count';TKName:'NLineCount'),
                                                         (SQLName:'note_folio';TKName:'NoteFolio'),
                                                         ...
                                                         (SQLName:'in_bin_code';TKName:'InBinCode'),
                                                         (SQLName:'return_sno';TKName:'ReturnSNo'),
                                                         (SQLName:'batch_ret_qty';TKName:'BatchRetQty'),
                                                         (SQLName:'ret_doc';TKName:'RetDoc'),
                                                         (SQLName:'ret_doc_line';TKName:'RetDocLine')
                                                        );
var
  i : integer;
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'FR');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'ME');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'UC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'W*');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'XA');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'R1');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'A2');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('EXSTKCHK', FieldNames[i].SQLName, 'AL');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Faxes', FieldNames[i].SQLName, 'AL');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Forms', FieldNames[i].SQLName, 'AL');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Groupcmp', FieldNames[i].SQLName, 'AL');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Groups', FieldNames[i].SQLName, 'AL');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Groupusr', FieldNames[i].SQLName, 'AL');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('History', FieldNames[i].SQLName, 'AL');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Importjob', FieldNames[i].SQLName, 'AL');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Jobctrl', FieldNames[i].SQLName, 'JB');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Jobctrl', FieldNames[i].SQLName, 'JM');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Jobctrl', FieldNames[i].SQLName, 'JS');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Jobctrl', FieldNames[i].SQLName, 'JE');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Jobctrl', FieldNames[i].SQLName, 'JR');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('JobDet', FieldNames[i].SQLName, 'JE');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('JobDet', FieldNames[i].SQLName, 'JR');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('JobDet', FieldNames[i].SQLName, 'TS');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Jobhead', FieldNames[i].SQLName, 'TS');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('JobMisc', FieldNames[i].SQLName, 'JE');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('JobMisc', FieldNames[i].SQLName, 'JT');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('JobMisc', FieldNames[i].SQLName, 'JA');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Lbin', FieldNames[i].SQLName, 'JA');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Lheader', FieldNames[i].SQLName, 'JA');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Llines', FieldNames[i].SQLName, 'JA');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Lserial', FieldNames[i].SQLName, 'JA');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('MCPAY', FieldNames[i].SQLName, 'JA');
      Break;
    end;
  end;
end;
...
const
  ...
  FieldNames : Array[1..NumberOfFields] of TFieldName = (
                                                         ...
                                                         (SQLName:'lo_addr1';TKName:'LoAddr1'),
                                                         (SQLName:'lo_addr2';TKName:'LoAddr2'),
                                                         (SQLName:'lo_addr3';TKName:'LoAddr3'),
                                                         (SQLName:'lo_addr4';TKName:'LoAddr4'),
                                                         (SQLName:'lo_addr5';TKName:'LoAddr5'),
                                                         (SQLName:'lo_tel';TKName:'LoTel'),
                                                         ...
                                                         (SQLName:'lo_nominal1';TKName:'LoNominal1'),
                                                         (SQLName:'lo_nominal2';TKName:'LoNominal2'),
                                                         (SQLName:'lo_nominal3';TKName:'LoNominal3'),
                                                         (SQLName:'lo_nominal4';TKName:'LoNominal4'),
                                                         (SQLName:'lo_nominal5';TKName:'LoNominal5'),
                                                         ...
                                                         (SQLName:'lo_use_price';TKName:'LoUsePrice'),
                                                         (SQLName:'lo_use_nom';TKName:'LoUseNom'),
                                                         (SQLName:'lo_use_cc_dep';TKName:'LoUseCCDep'),
                                                         (SQLName:'lo_use_supp';TKName:'LoUseSupp'),
                                                         (SQLName:'lo_use_bin_loc';TKName:'LoUseBinLoc'),
                                                         (SQLName:'lo_n_line_count';TKName:'LoNLineCount'),
                                                         (SQLName:'lo_use_c_price';TKName:'LoUseCPrice'),
                                                         (SQLName:'lo_use_r_price';TKName:'LoUseRPrice'),
                                                         (SQLName:'lo_wopwipgl';TKName:'LoWOPWIPGL'),
                                                         (SQLName:'lo_return_gl';TKName:'LoReturnGL'),
                                                         (SQLName:'lo_p_return_gl';TKName:'LoPReturnGL')
                                                        );
var
  i : integer;
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'CC');
      Break;
    end;
  end;
end;
...
const
  ...
  FieldNames : Array[1..NumberOfFields] of TFieldName = (
                                                         ...
                                                         (SQLName:'var_code2';TKName:'varCode2'),
                                                         (SQLName:'var_code3';TKName:'varCode3'),
                                                         (SQLName:'ls_stk_code';TKName:'LsStkCode'),
                                                         (SQLName:'ls_stk_folio';TKName:'LsStkFolio'),
                                                         (SQLName:'ls_loc_code';TKName:'LsLocCode'),
                                                         (SQLName:'ls_qty_in_stock';TKName:'LsQtyInStock'),
                                                         (SQLName:'ls_qty_on_order';TKName:'LsQtyOnOrder'),
                                                         (SQLName:'ls_qty_alloc';TKName:'LsQtyAlloc'),
                                                         (SQLName:'ls_qty_picked';TKName:'LsQtyPicked'),
                                                         (SQLName:'ls_qty_min';TKName:'LsQtyMin'),
                                                         (SQLName:'ls_qty_max';TKName:'LsQtyMax'),
                                                         (SQLName:'ls_qty_freeze';TKName:'LsQtyFreeze'),
                                                         (SQLName:'ls_ro_qty';TKName:'LsRoQty'),
                                                         (SQLName:'ls_ro_date';TKName:'LsRoDate'),
                                                         (SQLName:'ls_ro_cc_dep1';TKName:'LsRoDepartment'),
                                                         (SQLName:'ls_ro_cc_dep2';TKName:'LsRoCostCentre'),
                                                         (SQLName:'ls_cc_dep1';TKName:'LsDepartment'),
                                                         (SQLName:'ls_cc_dep2';TKName:'LsCostCentre'),
                                                         (SQLName:'ls_bin_loc';TKName:'LsBinLoc'),
                                                         (SQLName:'currency1';TKName:'Currency1'),
                                                         (SQLName:'sales_price1';TKName:'SalesPrice1'),
                                                         (SQLName:'currency2';TKName:'Currency2'),
                                                         (SQLName:'sales_price2';TKName:'SalesPrice2'),
                                                         (SQLName:'currency3';TKName:'Currency3'),
                                                         (SQLName:'sales_price3';TKName:'SalesPrice3'),
                                                         (SQLName:'currency4';TKName:'Currency4'),
                                                         (SQLName:'sales_price4';TKName:'SalesPrice4'),
                                                         (SQLName:'currency5';TKName:'Currency5'),
                                                         (SQLName:'sales_price5';TKName:'SalesPrice5'),
                                                         (SQLName:'currency6';TKName:'Currency6'),
                                                         (SQLName:'sales_price6';TKName:'SalesPrice6'),
                                                         (SQLName:'currency7';TKName:'Currency7'),
                                                         (SQLName:'sales_price7';TKName:'SalesPrice7'),
                                                         (SQLName:'currency8';TKName:'Currency8'),
                                                         (SQLName:'sales_price8';TKName:'SalesPrice8'),
                                                         (SQLName:'currency9';TKName:'Currency9'),
                                                         (SQLName:'sales_price9';TKName:'SalesPrice9'),
                                                         (SQLName:'currency10';TKName:'Currency10'),
                                                         (SQLName:'sales_price10';TKName:'SalesPrice10'),
                                                         (SQLName:'ls_ro_price';TKName:'LsRoPrice'),
                                                         (SQLName:'ls_ro_currency';TKName:'LsRoCurrency'),
                                                         (SQLName:'ls_cost_price';TKName:'LsCostPrice'),
                                                         (SQLName:'ls_p_currency';TKName:'LsPCurrency'),
                                                         (SQLName:'ls_def_nom1';TKName:'LsDefNom1'),
                                                         (SQLName:'ls_def_nom2';TKName:'LsDefNom2'),
                                                         (SQLName:'ls_def_nom3';TKName:'LsDefNom3'),
                                                         (SQLName:'ls_def_nom4';TKName:'LsDefNom4'),
                                                         (SQLName:'ls_def_nom5';TKName:'LsDefNom5'),
                                                         (SQLName:'ls_def_nom6';TKName:'LsDefNom6'),
                                                         (SQLName:'ls_def_nom7';TKName:'LsDefNom7'),
                                                         (SQLName:'ls_def_nom8';TKName:'LsDefNom8'),
                                                         (SQLName:'ls_def_nom9';TKName:'LsDefNom9'),
                                                         (SQLName:'ls_def_nom10';TKName:'LsDefNom10'),
                                                         (SQLName:'ls_stk_flg';TKName:'LsStkFlg'),
                                                         (SQLName:'ls_min_flg';TKName:'LsMinFlg'),
                                                         (SQLName:'ls_temp_supp';TKName:'LsTempSupp'),
                                                         (SQLName:'ls_supplier';TKName:'LsSupplier'),
                                                         (SQLName:'ls_last_used';TKName:'LsLastUsed'),
                                                         (SQLName:'ls_qty_posted';TKName:'LsQtyPosted'),
                                                         (SQLName:'ls_qty_take';TKName:'LsQtyTake'),
                                                         (SQLName:'ls_ro_flg';TKName:'LsROFlg'),
                                                         (SQLName:'ls_last_time';TKName:'LsLastTime'),
                                                         (SQLName:'ls_qty_alloc_wor';TKName:'LsQtyAllocWOR'),
                                                         (SQLName:'ls_qty_issue_wor';TKName:'LsQtyIssueWOR'),
                                                         (SQLName:'ls_qty_pick_wor';TKName:'LsQtyPickWOR'),
                                                         (SQLName:'ls_wopwipgl';TKName:'LsWOPWIPGL'),
                                                         (SQLName:'ls_s_warranty';TKName:'LsSWarranty'),
                                                         (SQLName:'ls_s_warranty_type';TKName:'LsSWarrantyType'),
                                                         (SQLName:'ls_m_warranty';TKName:'LsMWarranty'),
                                                         (SQLName:'ls_m_warranty_type';TKName:'LsMWarrantyType'),
                                                         (SQLName:'ls_qty_p_return';TKName:'LsQtyPReturn'),
                                                         (SQLName:'ls_return_gl';TKName:'LsReturnGL'),
                                                         (SQLName:'ls_re_stock_pcnt';TKName:'LsReStockPcnt'),
                                                         (SQLName:'ls_re_stock_gl';TKName:'LsReStockGL'),
                                                         (SQLName:'ls_bom_ded_comp';TKName:'LsBOMDedComp'),
                                                         (SQLName:'ls_qty_return';TKName:'LsQtyReturn'),
                                                         (SQLName:'ls_p_return_gl';TKName:'LsPReturnGL')
                                                        );
var
  i : integer;
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'CD');
      Break;
    end;
  end;
end;
...
const
  ...
  FieldNames : Array[1..NumberOfFields] of TFieldName = (
                                                         ...
                                                         (SQLName:'sd_supp_code';TKName:'SdSuppCode'),
                                                         (SQLName:'sd_alt_code';TKName:'SdAltCode'),
                                                         (SQLName:'sd_ro_currency';TKName:'SdROCurrency'),
                                                         (SQLName:'sd_ro_price';TKName:'SdRoPrice'),
                                                         (SQLName:'sd_n_line_count';TKName:'SdNLineCount'),
                                                         (SQLName:'sd_last_used';TKName:'SdLastUsed'),
                                                         (SQLName:'sd_over_ro';TKName:'SdOverRO'),
                                                         (SQLName:'sd_desc';TKName:'SdDesc'),
                                                         (SQLName:'sd_last_time';TKName:'SdLastTime'),
                                                         (SQLName:'sd_over_min_ecc';TKName:'SdOverMinEcc'),
                                                         (SQLName:'sd_min_ecc_qty';TKName:'SdMinEccQty'),
                                                         (SQLName:'sd_over_line_qty';TKName:'SdOverLineQty'),
                                                         (SQLName:'sd_line_qty';TKName:'SdLineQty'),
                                                         (SQLName:'sd_line_no';TKName:'SdLineNo')
                                                        );
var
  i : integer;
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'N*');
      Break;
    end;
  end;
end;
...
const
  ...
  FieldNames : Array[1..NumberOfFields] of TFieldName = (
                                                         ...
                                                         (SQLName:'var_code2';TKName:'varCode2'),
                                                         (SQLName:'var_code3';TKName:'varCode3'),
                                                         (SQLName:'cs_cust_code';TKName:'CsCustCode'),
                                                         (SQLName:'cs_stock_code';TKName:'CsStockCode'),
                                                         (SQLName:'cs_stk_folio';TKName:'CsStkFolio'),
                                                         (SQLName:'cs_so_qty';TKName:'CsSOQty'),
                                                         (SQLName:'cs_last_date';TKName:'CsLastDate'),
                                                         (SQLName:'cs_line_no';TKName:'CsLineNo'),
                                                         (SQLName:'cs_last_price';TKName:'CsLastPrice'),
                                                         (SQLName:'cs_lp_curr';TKName:'CsLPCurr'),
                                                         (SQLName:'cs_job_code';TKName:'CsJobCode'),
                                                         (SQLName:'cs_ja_code';TKName:'CsJACode'),
                                                         (SQLName:'cs_loc_code';TKName:'CsLocCode'),
                                                         (SQLName:'cs_nom_code';TKName:'CsNomCode'),
                                                         (SQLName:'cs_cc_dep1';TKName:'CsDepartment'),
                                                         (SQLName:'cs_cc_dep2';TKName:'CsCostCentre'),
                                                         (SQLName:'cs_qty';TKName:'CsQty'),
                                                         (SQLName:'cs_net_value';TKName:'CsNetValue'),
                                                         (SQLName:'csdiscount';TKName:'CsDiscount'),
                                                         (SQLName:'cs_vat_code';TKName:'CsVATCode'),
                                                         ...
                                                         (SQLName:'cs_qty_pack';TKName:'CsQtyPack'),
                                                         (SQLName:'cs_qty_mul';TKName:'CsQtyMul'),
                                                         (SQLName:'cs_disc_ch';TKName:'CsDiscCh'),
                                                         (SQLName:'cs_entered';TKName:'CsEntered'),
                                                         (SQLName:'cs_use_pack';TKName:'CsUsePack'),
                                                         (SQLName:'cs_show_case';TKName:'CsShowCase'),
                                                         (SQLName:'cs_line_type';TKName:'CsLineType'),
                                                         (SQLName:'cs_price_mul_x';TKName:'CsPriceMulX'),
                                                         (SQLName:'cs_vat_inc_flg';TKName:'CsVATIncFlg')
                                                        );
var
  i : integer;
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'TP');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'TK');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'ED');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'PD');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'XC');
      Break;
    end;
  end;
end;
...
const
  ...
  FieldNames : Array[1..NumberOfFields] of TFieldName = (
                                                         ...
                                                         (SQLName:'var_code2';TKName:'varCode2'),
                                                         (SQLName:'var_code3';TKName:'varCode3'),
                                                         (SQLName:'br_in_doc';TKName:'BrInDoc'),
                                                         (SQLName:'br_out_doc';TKName:'BrOutDoc'),
                                                         (SQLName:'br_sold';TKName:'BrSold'),
                                                         (SQLName:'br_date_in';TKName:'BrDateIn'),
                                                         (SQLName:'br_bin_cost';TKName:'BrBinCost'),
                                                         (SQLName:'br_bin_cap';TKName:'BrBinCap'),
                                                         (SQLName:'spare5';TKName:'Spare5'),
                                                         (SQLName:'br_stk_folio';TKName:'BrStkFolio'),
                                                         (SQLName:'br_date_out';TKName:'BrDateOut'),
                                                         (SQLName:'br_sold_line';TKName:'BrSoldLine'),
                                                         (SQLName:'br_buy_line';TKName:'BrBuyLine'),
                                                         (SQLName:'br_batch_rec';TKName:'BrBatchRec'),
                                                         (SQLName:'br_buy_qty';TKName:'BrBuyQty'),
                                                         (SQLName:'br_qty_used';TKName:'BrQtyUsed'),
                                                         (SQLName:'br_batch_child';TKName:'BrBatchChild'),
                                                         (SQLName:'br_in_mloc';TKName:'BrInMLoc'),
                                                         (SQLName:'br_out_mloc';TKName:'BrOutMLoc'),
                                                         (SQLName:'br_out_ord_doc';TKName:'BrOutOrdDoc'),
                                                         (SQLName:'br_in_ord_doc';TKName:'BrInOrdDoc'),
                                                         (SQLName:'br_in_ord_line';TKName:'BrInOrdLine'),
                                                         (SQLName:'br_out_ord_line';TKName:'BrOutOrdLine'),
                                                         (SQLName:'br_cur_cost';TKName:'BrCurCost'),
                                                         (SQLName:'br_priority';TKName:'BrPriority'),
                                                         (SQLName:'br_bin_sell';TKName:'BrBinSell'),
                                                         (SQLName:'br_Ser_CRates1';TKName:'brSerCompanyRate'),
                                                         (SQLName:'br_Ser_CRates2';TKName:'brSerDailyRate'),
                                                         (SQLName:'br_suse_o_rate';TKName:'BrSUseORate'),
                                                         ...
                                                         (SQLName:'br_date_use_x';TKName:'BrDateUseX'),
                                                         (SQLName:'br_cur_sell';TKName:'BrCurSell'),
                                                         (SQLName:'br_uom';TKName:'BrUOM'),
                                                         (SQLName:'br_hold_flg';TKName:'BrHoldFlg'),
                                                         (SQLName:'br_tag_no';TKName:'BrTagNo'),
                                                         (SQLName:'br_return_bin';TKName:'BrReturnBin')
                                                        );
var
  i : integer;
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'IR');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'K1');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'K2');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'K3');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'K4');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Mlocstk', FieldNames[i].SQLName, 'K5');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Nominal', FieldNames[i].SQLName, '');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Nomview', FieldNames[i].SQLName, 'NV');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Nomview', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('PAAUTH', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('PACOMP', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('PAEAR', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('PAGLOBAL', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Papersize', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('PAUSER', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('PPCUST', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('PPDEBT', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('PPSETUP', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Reports', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('SALECODE', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('SCHEDCFG', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('SCHEDULE', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('SCTYPE', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Sent', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('SentLine', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Settings', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Stock', FieldNames[i].SQLName, '');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Tillname', FieldNames[i].SQLName, 'NC');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Tools', FieldNames[i].SQLName, 'M');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Tools', FieldNames[i].SQLName, 'U');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Tools', FieldNames[i].SQLName, 'S');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('Tools', FieldNames[i].SQLName, 'C');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('UDENTITY', FieldNames[i].SQLName, 'C');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('UDFIELD', FieldNames[i].SQLName, 'C');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('UDITEM', FieldNames[i].SQLName, 'C');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('VATOPT', FieldNames[i].SQLName, 'C');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('VATPRD', FieldNames[i].SQLName, 'C');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('VRWSEC', FieldNames[i].SQLName, 'C');
      Break;
    end;
  end;
end;
...
begin
  ...
  begin
    if Trim(UpperCase(Value)) = Trim(UpperCase(FieldNames[i].TkName)) then
    begin;
      Result := GetDBColumnName('VRWTREE', FieldNames[i].SQLName, 'C');
      Break;
    end;
  end;
end;
