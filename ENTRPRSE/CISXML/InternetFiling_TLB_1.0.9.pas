...
// File generated on 13/03/2007 14:58:52 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Projects\CIS\FBI Components\Release 1.0.9\InternetFiling.tlb (1)
...
//   Hint: Parameter 'Class' of IPosting.RequestListCOM changed to 'Class_'
...
//   Hint: Parameter 'Class' of _Posting.RequestListCOM changed to 'Class_'
...
const
  ...
  IID__Posting: TGUID = '{C2794E4A-23D4-3ADC-82DF-05BF4DCD4A43}';
...
// *********************************************************************//
  IPosting = dispinterface
    ...
    function RequestListCOM(const CorrelationID: WideString; const Class_: WideString; 
...
// GUID:      {C2794E4A-23D4-3ADC-82DF-05BF4DCD4A43}
// *********************************************************************//
  _Posting = interface(IDispatch)
    ['{C2794E4A-23D4-3ADC-82DF-05BF4DCD4A43}']
...
// *********************************************************************//
  _PostingDisp = dispinterface
    ...
    function RequestListCOM(const CorrelationID: WideString; const Class_: WideString; 
                            UsesTestGateway: WordBool; const GovTalkUrl: WideString): WideString; dispid 1610743822;
    function BeginPolling_3(const callback: ICallback; const CorrelationID: WideString; 
                            const Class_: WideString; UsesTestGateway: WordBool; 
                            const GovTalkUrl: WideString; PollingIntervalWholeSeconds: Integer): WideString; dispid 1610743823;
    function RequestList(const CorrelationID: WideString; const Class_: WideString; 
                         UsesTestGateway: WordBool; const GovTalkUrl: WideString): IUnknown; dispid 1610743824;
  end;
...
{$ENDIF}
  ...
  public
    ...
    function AddIRMark_2(var DocumentXml: WideString; const Namespace: WideString): WideString;
    function Submit(const Class_: WideString; UsesTestGateway: WordBool; 
...
const
  CServerData: TServerData = (
    ...
    IntfIID:   '{C2794E4A-23D4-3ADC-82DF-05BF4DCD4A43}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
function TPosting.AddIRMark_2(var DocumentXml: WideString; const Namespace: WideString): WideString;
begin
  Result := DefaultInterface.AddIRMark_2(DocumentXml, Namespace);
end;
...
function TPosting.RequestListCOM(const CorrelationID: WideString; const Class_: WideString; 
                                 UsesTestGateway: WordBool; const GovTalkUrl: WideString): WideString;
begin
  Result := DefaultInterface.RequestListCOM(CorrelationID, Class_, UsesTestGateway, GovTalkUrl);
end;
