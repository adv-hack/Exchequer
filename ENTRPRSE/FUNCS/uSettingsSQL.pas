...
//    procedure ExportBtrieveFileTo(sFileName : string);
    ...
    property SQL : boolean read fSQL; // NF: 02/02/2010
  end;
...
Begin{oSettings}
  ...
  // NF: 02/02/2010
  // This will will recreate the datamodule,
  // This is necessary if you have called Disconnect, and then continue to use the settings object
  if oLSettings.fSQL and (not Assigned(oLSettings.dmSettings)) then
  begin
    // MS-SQL
    oLSettings.dmSettings := TdmSettingsSQL.Create(nil);
    oLSettings.dmSettings.Connect;
  end;{if}
