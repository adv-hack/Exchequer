...
begin
  Result := GetDBColumnName('Mlocstk.dat', 'rec_pfix', '') + ',' + 
            ...
            GetDBColumnName('Mlocstk.dat', 'var_code2', '') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'var_code3', '') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_cust_code', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_stock_code', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_stk_folio', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_so_qty', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_last_date', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_line_no', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_last_price', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_lp_curr', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_job_code', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_ja_code', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_loc_code', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_nom_code', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_cc_dep1', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_cc_dep2', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_qty', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_net_value', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'csdiscount', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_vat_code', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_cost', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_desc1', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_desc2', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_desc3', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_desc4', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_desc5', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_desc6', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_vat', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_prx_pack', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_qty_pack', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_qty_mul', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_disc_ch', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_entered', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_use_pack', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_show_case', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_line_type', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_price_mul_x', 'TP') + ',' + 
            GetDBColumnName('Mlocstk.dat', 'cs_vat_inc_flg', 'TP') ;
end;
