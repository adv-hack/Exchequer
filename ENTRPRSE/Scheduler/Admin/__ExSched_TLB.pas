...
// File generated on 25/09/2006 16:29:32 from Type Library described below.
...
const
  ...
  ExSchedMajorVersion = 1;
  ExSchedMinorVersion = 0;

  LIBID_ExSched: TGUID = '{6D199F83-5804-4E94-928A-55BFE33795D1}';
...
// *********************************************************************//
  IScheduledTaskEvents = dispinterface
    ...
    procedure OnProgress(const sMessage: WideString); dispid 1;
  end;
