...
{    1. SysMsg: string read GetSysMsg; which returns TErrors.SysMsg            }
{    2. SysMsgSet: boolean read GetSysMsgSet; which returns TErrors.SysMsgSet  }
{   Each object class also implements a SetSysMsg(Value: string) procedure     }
{   which in turn calls TErrors.SetSysMsg(Value);                              }
{                                                                              }
