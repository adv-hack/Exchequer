...
const
  ...
  //PR: 10/06/2009 Added Multi-Buy Discount file
  //PR: 10/02/2012 Added QtyBreak File
  //PR: 30/01/2014 Added Account Contacts file ABSEXCH-14974

  //PR: 14/10/2014 Added Order Payments file (OPVATPay.Dat)
  NoOfAvailFiles = 39;
  ...
  , 'CIS Vouchers', 'Multi-Bins', 'Alternative Stock Codes', 'Multi-Buy Discounts', 'Qty Breaks'
  , 'Account Contact Roles', 'Order Payments');
  ...
  , 268435456, 536870912, 1073741824, 1, 2, 4, 8, 16, 32, 64, 128);
