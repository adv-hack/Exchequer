...
// File generated on 10/10/2007 16:17:28 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\EXCH600.PSQL\ENTER1.EXE (1)
...
// *********************************************************************//
  ...
  TCOMCustomisationOnHook = procedure(Sender: TObject; var EventData: OleVariant) of object;
...
begin
  case DispID of
   ...
   1: if Assigned(FOnHook) then
            FOnHook(Self, Params[0] {const ICOMEventData});
