inherited frmSelectExchPervasiveDir: TfrmSelectExchPervasiveDir
  Left = 394
  Top = 127
  HelpContext = 2
  ...
  Caption = 'frmSelectExchPervasiveDir'
  ClientHeight = 452
  ClientWidth = 400
  ...
  inherited lblBanner: TLabel
    Width = 298
    Caption = 'Select Pervasive Directory'
  end
  object InstrLbl: TLabel [2]
    ...
    AutoSize = False
    Caption = 
      'Please select the main directory of the Exchequer Pervasive Edit' +
      'ion system that you want to convert within the tree below.  The ' +
      'Exchequer main directory is the directory that contains Company.' +
      'Dat and Entrprse.Dat.'
    WordWrap = True
  end
