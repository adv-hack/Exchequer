...
Type
  TEbusDocDataWrite = Class(TBaseDataWrite)
  Private
    FADOQuery : TADOQuery;
...
Constructor TEbusDocDataWrite.Create;
Begin // Create
  Inherited Create;
...
Destructor TEbusDocDataWrite.Destroy;
Begin // Destroy
...
// Called from the SQL Write Threads to provide basic info required for SQL Execution
Procedure TEbusDocDataWrite.Prepare (Const ADOConnection : TADOConnection; Const CompanyCode : ShortString);
Var
  sqlQuery : ANSIString;
Begin // Prepare
  ...
  sqlQuery := 'INSERT INTO [COMPANY].EBUSDOC (' +
                                               'thRunNo, ' + 
                                               'thAcCode, ' + 
                                               'thNomAuto, ' + 
                                               'thOurRef, ' +
...
Procedure TEbusDocDataWrite.SetQueryValues (Var ADOQuery : TADOQuery; Const DataPacket : TDataPacket; Var SkipRecord : Boolean);
Var
  DataRec : ^InvRec;
