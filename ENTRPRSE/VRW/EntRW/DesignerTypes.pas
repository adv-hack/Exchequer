...
Type
  ...
  TOnControlAddedProc = procedure(Added: Boolean) of Object;
  ...
  TControlContextItems = (cciCut, cciCopy, cciDelete,
                          ...
                          cciRangeFilter,
                          cciSelectionCriteria, cciPrintIf,
  ...
  TDesignerControlTypes = (dctNone, dctText, dctImage, dctBox, dctDBField, dctFormula, dctReportProperties);
  ...
  IRegionManager = Interface
    ...
    Property rmPaperSizeHeight : SmallInt Read GetPaperSizeHeight;
    // rmPaperSizeWidth is the width of the paper, e.g. 210mm for A4
    Property rmPaperSizeWidth : SmallInt Read GetPaperSizeWidth;
    ...
    Property rmPaperWidth : SmallInt Read GetPaperWidth;
    ...
    // Optional event for notifying that a control has been added to the
    // report. Called whether or not the control was successfully added -- the
    // Added parameter will indicate this.
    property OnControlAdded: TOnControlAddedProc read GetOnControlAdded write SetOnControlAdded;
  ...
  IRegionManager2 = interface(IRegionManager)
  ['{46472B3F-1899-4812-A70D-43F466FDA147}']
    ...
    { --- Properties --------------------------------------------------------- }
    property rmUserID: ShortString read GetUserID write SetUserID;
