...
type
  ...
  TfrmReportDesigner = class(TForm)
    ...
    imgDefaultImage: TImage;
    imgRunReport: TImage;
    imgCancelReport: TImage;
    ...
    tbReportText: TToolButton;
    tbReportImage: TToolButton;
    tbReportBox: TToolButton;
    tbReportDBField: TToolButton;
    tbReportFormula: TToolButton;
    ToolButton8: TToolButton;
    tbRunReport: TToolButton;
    ToolButton10: TToolButton;
    tbReportTree: TToolButton;
    ...
    procedure sbReportTextClick(Sender: TObject);
    procedure sbReportFormulaClick(Sender: TObject);
    procedure sbReportDBFieldClick(Sender: TObject);
    procedure sbReportImageClick(Sender: TObject);
    procedure sbReportTreeClick(Sender: TObject);
    procedure sbReportBoxClick(Sender: TObject);
...
procedure TfrmReportDesigner.sbReportTextClick(Sender: TObject);
begin
end;

//------------------------------

procedure TfrmReportDesigner.sbReportImageClick(Sender: TObject);
begin
end;

//------------------------------

procedure TfrmReportDesigner.sbReportBoxClick(Sender: TObject);
begin
end;

//------------------------------

procedure TfrmReportDesigner.sbReportDBFieldClick(Sender: TObject);
begin
end;

//------------------------------

procedure TfrmReportDesigner.sbReportFormulaClick(Sender: TObject);
begin
end;

//------------------------------

procedure TfrmReportDesigner.sbReportTreeClick(Sender: TObject);
begin
end;
...
//  ShowMessage ('Range Filters Not Coded');
  DisplayRangeFilters (FRegionManager.rmReport, rflmDesignTime); // IVRWReport
end;
...
procedure TfrmReportDesigner.ReportPropertiesClick(Sender: TObject);
var
  OldW, OldH: Integer;
begin
...
Var
  ...
  I, NextLeft, NextTop, RightMost : SmallInt;
...
{ TODO : The first control should really be positioned 1 mm after the left waste - if we knew what it was!}
        ...
        Begin
          ...
          Begin
            ...
            Begin
              ...
              AutoCalcControlSize (FRegionManager, TextI, StringOfChar('M', Length(Trim(pDataRec.Caption)) + 1));
    ...
    Fml := regPageHdr.rgControls.Add(regPageHdr.rgReport, ctFormula) as IVRWFormulaControl;
    try
      Fml.vcFormulaDefinition := '""Printed" + <SPACE> + ":" + <SPACE> + INFO[DATE] + <SPACE> + "-" + <SPACE> + INFO[TIME]';
    ...
    try
      Fml.vcFormulaDefinition :=
        '""User" + <SPACE> + ":" + <SPACE> + DBF[SYSLUSER] + "." + <SPACE> + ' +
        '""Page" + <SPACE> + ":" + <SPACE> + INFO[CURRENTPAGE]';
    ...
    begin
      (Labels[i] as IVRWControl).vcTop :=
        (Labels[i] as IVRWControl).vcTop + NextTop + 2;
    end;
