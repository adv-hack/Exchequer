...
// Unit to read/write *.ini files greater than 64 kB without windows API
// (c) Edy Hinzen 1996-2004 - Freeware
// See help file for details, disclaimer and contact information
// http://www.hinzen.de/delphi for latest version	
//------------------------------------------------------------------------------
...
begin
  SectionCount := FSectionList.Count;
  with FSectionList do
  begin
    for ixSections := 0 to SectionCount -1 do
    begin
      if assigned(SectionItems[ixSections]) then
        try
