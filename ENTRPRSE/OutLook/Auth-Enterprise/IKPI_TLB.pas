...
// ************************************************************************  //
// Type Lib: C:\Develop\Entrprse\IKPIHost.dll (1)
...
// Parent TypeLibrary:
//   (0) v1.0 IRISEnterpriseKPI, (X:\ENTRPRSE\OutLook\Auth-Enterprise\IEAuth.tlb)
// ************************************************************************ //
...
const
  ...
  LIBID_IKPI: TGUID = '{F2C97C48-284D-4412-B2B6-C3F9447BCF98}';

  IID_ITestAddin: TGUID = '{90CA9530-3134-4419-8551-BCE9C381C441}';
  CLASS_TestAddin: TGUID = '{612BA9CF-8817-4A50-B7EA-3A76966A9D4A}';
...
// *********************************************************************//
  ITestAddin = interface;
  ITestAddinDisp = dispinterface;
...
// *********************************************************************//
  TestAddin = ITestAddin;


// *********************************************************************//
// Interface: ITestAddin
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {90CA9530-3134-4419-8551-BCE9C381C441}
// *********************************************************************//
  ITestAddin = interface(IDispatch)
    ['{90CA9530-3134-4419-8551-BCE9C381C441}']
  end;

// *********************************************************************//
// DispIntf:  ITestAddinDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {90CA9530-3134-4419-8551-BCE9C381C441}
// *********************************************************************//
  ITestAddinDisp = dispinterface
...
// *********************************************************************//
// The Class CoTestAddin provides a Create and CreateRemote method to          
// create instances of the default interface ITestAddin exposed by              
// the CoClass TestAddin. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoTestAddin = class
    class function Create: ITestAddin;
    class function CreateRemote(const MachineName: string): ITestAddin;
  end;
...
class function CoTestAddin.Create: ITestAddin;
begin
  Result := CreateComObject(CLASS_TestAddin) as ITestAddin;
end;

class function CoTestAddin.CreateRemote(const MachineName: string): ITestAddin;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_TestAddin) as ITestAddin;
end;
