...
type
  ...
  private
    ...
    procedure SetRoot(const Value: TRoot2005);
  ...
  public
    ...
    property Root: TRoot2005 read FRoot write SetRoot;
  ...
  TCustomShellComboBox2005 = class;
...
{ TCustomShellTreeView2005 }

  TCustomShellTreeView2005 = class(TCustomTreeView, IShellCommandVerb)
  private
    FRoot,
    FOldRoot : TRoot2005;
    ...
    FAutoContext,
    FUpdating: Boolean;
    FComboBox: TCustomShellComboBox2005;
    ...
    procedure SetComboBox(Value: TCustomShellComboBox2005);
  ...
  public
    ...
    property Root: TRoot2005 read FRoot write SetRoot;
    property ShellComboBox: TCustomShellComboBox2005 read FComboBox write SetComboBox;
...
{ TShellTreeView2005 }
  ...
  TShellTreeView2005 = class(TCustomShellTreeView2005)
  published
...
{ TCustomShellComboBox2005 }

  TCustomShellComboBox2005 = class(TCustomComboBoxEx)
  private
    FImages,
    FImageHeight,
    FImageWidth: Integer;
    ...
    FRoot: TRoot2005;
    FRootFolder: TShellFolder;
    FTreeView: TCustomShellTreeView2005;
    FListView: TCustomShellListView;
    FObjectTypes: TShellObjectTypes;
    FUseShellImages,
    FUpdating: Boolean;
    ...
    procedure SetPathFromID(ID: PItemIDList);
    procedure SetRoot(const Value: TRoot2005);
    procedure SetTreeView(Value: TCustomShellTreeView2005);
  ...
  public
    ...
    property Root: TRoot2005 read FRoot write SetRoot;
    property ObjectTypes: TShellObjectTypes read FObjectTypes write SetObjectTypes;
    property ShellTreeView: TCustomShellTreeView2005 read FTreeView write SetTreeView;
    property ShellListView: TCustomShellListView read FListView write SetListView;
    property UseShellImages: Boolean read FUseShellImages write SetUseShellImages;
...
{ TShellComboBox2005 }
  ...
  TShellComboBox2005 = class(TCustomShellComboBox2005)
  published
    property Images;
    property Root;
...
uses ShellConsts2005, ShellAPI, ComObj, TypInfo, Menus, Consts, Math;
...
function CreateRootFolder(RootFolder: TShellFolder; OldRoot : TRoot2005;
  var NewRoot: TRoot2005): TShellFolder;
var
  P: PWideChar;
  NewPIDL: PItemIDList;
  NumChars,
...
procedure TCustomShellChangeNotifier.SetRoot(const Value: TRoot2005);
begin
...
constructor TCustomShellTreeView2005.Create(AOwner: TComponent);
var
  FileInfo: TSHFileInfo;
begin
...
procedure TCustomShellTreeView2005.ClearItems;
var
  I: Integer;
begin
  Items.BeginUpdate;
...
procedure TCustomShellTreeView2005.CreateWnd;
begin
  inherited CreateWnd;
...
procedure TCustomShellTreeView2005.DestroyWnd;
begin
  ClearItems;
  inherited DestroyWnd;
end;

procedure TCustomShellTreeView2005.CommandCompleted(Verb: String;
  Succeeded: Boolean);
var
  Fldr : TShellFolder;
begin
...
procedure TCustomShellTreeView2005.ExecuteCommand(Verb: String;
  var Handled: Boolean);
var
  szPath: array[0..MAX_PATH] of char;
begin
...
procedure TCustomShellTreeView2005.InitNode(NewNode: TTreeNode; ID: PItemIDList; ParentNode: TTreeNode);
var
  CanAdd: Boolean;
...
procedure TCustomShellTreeView2005.PopulateNode(Node: TTreeNode);
var
  ID: PItemIDList;
  EnumList: IEnumIDList;
  NewNode: TTreeNode;
...
procedure TCustomShellTreeView2005.SetObjectTypes(Value: TShellObjectTypes);
begin
  FObjectTypes := Value;
  RootChanged;
end;

procedure TCustomShellTreeView2005.CreateRoot;
var
  RootNode: TTreeNode;
  ErrorMsg: string;
begin
...
function TCustomShellTreeView2005.CanExpand(Node: TTreeNode): Boolean;
var
  Fldr: TShellFolder;
begin
  Result := True;
...
procedure TCustomShellTreeView2005.Edit(const Item: TTVItem);
var
  S: string;
  Node: TTreeNode;
begin
...
procedure TCustomShellTreeView2005.MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
function TCustomShellTreeView2005.NodeFromRelativeID(ParentNode: TTreeNode; ID: PItemIDList): TTreeNode;
var
  HR: HResult;
begin
...
function TCustomShellTreeView2005.NodeFromAbsoluteID(StartNode: TTreeNode; ID: PItemIDList): TTreeNode;
var
  HR: HResult;
begin
  Result := StartNode;
...
procedure TCustomShellTreeView2005.Delete(Node: TTreeNode);
begin
...
(*
procedure TCustomShellTreeView2005.NodeDeleted(Sender: TObject; Node: TTreeNode);
begin
  if Assigned(Node.Data) then
  begin
    TShellFolder(Node.Data).Free;
...
procedure TCustomShellTreeView2005.RootChanged;
begin
...
function TCustomShellTreeView2005.FolderExists(FindID: PItemIDList; InNode: TTreeNode): TTreeNode;
var
  ALevel: Integer;
begin
  Result := nil;
...
procedure TCustomShellTreeView2005.RefreshEvent;
begin
  if Assigned(Selected) then
    Refresh(Selected);
end;

procedure TCustomShellTreeView2005.Refresh(Node: TTreeNode);
var
...
procedure TCustomShellTreeView2005.Notification(AComponent: TComponent;
...
function TCustomShellTreeView2005.CanChange(Node: TTreeNode): Boolean;
var
  Fldr: TShellFolder;
  StayFresh: boolean;
begin
...
function TCustomShellTreeView2005.GetFolder(Index: Integer): TShellFolder;
begin
  Result := TShellFolder(Items[Index].Data);
end;

function TCustomShellTreeView2005.SelectedFolder: TShellFolder;
begin
  Result := nil;
  if Selected <> nil then Result := TShellFolder(Selected.Data);
end;

function TCustomShellTreeView2005.GetPath: String;
begin
...
procedure TCustomShellTreeView2005.SetPath(const Value: string);
var
  P: PWideChar;
  NewPIDL: PItemIDList;
  Flags,
...
procedure TCustomShellTreeView2005.SetPathFromID(ID: PItemIDList);
var
  I: Integer;
  Pidls: TList;
  Temp, Node: TTreeNode;
...
procedure TCustomShellTreeView2005.SetRoot(const Value: TRoot2005);
begin
  if not SameText(FRoot, Value) then
  begin
    FOldRoot := FRoot;
...
procedure TCustomShellTreeView2005.GetImageIndex(Node: TTreeNode);
begin
  if Assigned(Images) then
    inherited GetImageIndex(Node);
end;

procedure TCustomShellTreeView2005.GetSelectedIndex(Node: TTreeNode);
begin
  if Assigned(Images) then
    inherited GetSelectedIndex(Node);
end;

procedure TCustomShellTreeView2005.WndProc(var Message: TMessage);
var
...
procedure TCustomShellTreeView2005.SetUseShellImages(const Value: Boolean);
var
  ImageListHandle: THandle;
begin
...
procedure TCustomShellTreeView2005.WMDestroy(var Message: TWMDestroy);
begin
  ClearItems;
  inherited;
end;

procedure TCustomShellTreeView2005.Loaded;
begin
  inherited Loaded;
  CreateRoot;
end;

procedure TCustomShellTreeView2005.DoContextPopup(MousePos: TPoint;
  var Handled: Boolean);
begin
...
procedure TCustomShellTreeView2005.SetComboBox(Value: TCustomShellComboBox2005);
begin
...
procedure TCustomShellTreeView2005.SetListView(const Value: TCustomShellListView);
begin
...
procedure TCustomShellTreeView2005.SetAutoRefresh(const Value: boolean);
begin
  FAutoRefresh := Value;
...
constructor TCustomShellComboBox2005.Create(AOwner: TComponent);
var
  FileInfo: TSHFileInfo;
begin
  inherited Create(AOwner);
...
procedure TCustomShellComboBox2005.ClearItems;
var
  I: Integer;
begin
  ItemsEx.BeginUpdate;
...
procedure TCustomShellComboBox2005.CreateRoot;
var
  AFolder: TShellFolder;
  Text: string;
  ImageIndex: integer;
...
procedure TCustomShellComboBox2005.CreateWnd;
begin
  inherited CreateWnd;
  if FImages <> 0 then
...
procedure TCustomShellComboBox2005.DestroyWnd;
begin
  ClearItems;
  inherited DestroyWnd;
end;

procedure TCustomShellComboBox2005.SetObjectTypes(Value: TShellObjectTypes);
begin
  FObjectTypes := Value;
  RootChanged;
end;

procedure TCustomShellComboBox2005.TreeUpdate(NewPath: PItemIDList);
begin
...
procedure TCustomShellComboBox2005.SetTreeView(Value: TCustomShellTreeView2005);
begin
...
procedure TCustomShellComboBox2005.SetListView(Value: TCustomShellListView);
begin
  if Value = FListView then Exit;
  if Value <> nil then
  begin
...
procedure TCustomShellComboBox2005.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (Operation = opRemove) then
...
function TCustomShellComboBox2005.GetFolder(Index: Integer): TShellFolder;
begin
...
function TCustomShellComboBox2005.InitItem(ParentFolder: TShellFolder; ID: PItemIDList): TShellFolder;
var
  SF: IShellFolder;
begin
...
procedure TCustomShellComboBox2005.AddItems(Index: Integer; ParentFolder: TShellFolder);
var
  EnumList: IEnumIDList;
  ID: PItemIDList;
  ImageIndex: integer;
...
procedure TCustomShellComboBox2005.Init;
var
...
function TCustomShellComboBox2005.IndexFromID(AbsoluteID: PItemIDList): Integer;
begin
...
procedure TCustomShellComboBox2005.SetRoot(const Value: TRoot2005);
begin
  if not SameText(FRoot, Value) then
  begin
    FOldRoot := FRoot;
...
procedure TCustomShellComboBox2005.RootChanged;
begin
  FUpdating := True;
  try
    ClearItems;
...
function TCustomShellComboBox2005.GetPath: string;
var
  Folder : TShellFolder;
begin
  Result := '';
...
procedure TCustomShellComboBox2005.SetPath(const Value: string);
var
  P: PWideChar;
  NewPIDL: PItemIDList;
  Flags,
...
procedure TCustomShellComboBox2005.SetPathFromID(ID: PItemIDList);
var
  Pidls: TList;
  I, Item, Temp: Integer;
  AFolder: TShellFolder;
...
function TCustomShellComboBox2005.GetShellImageIndex(
...
procedure TCustomShellComboBox2005.SetUseShellImages(const Value: Boolean);
var
  ImageListHandle: THandle;
begin
  FUseShellImages := Value;
...
destructor TCustomShellComboBox2005.Destroy;
begin
  inherited Destroy;
  if Assigned(FImageList) then FImageList.Free;
end;

procedure TCustomShellComboBox2005.Loaded;
begin
  inherited Loaded;
  CreateRoot;
end;
...
procedure TCustomShellComboBox2005.Change;
var
  Node : TShellFolder;
begin
...
procedure TCustomShellComboBox2005.Click;
var
  Temp: PItemIDList;
begin
  FUpdating := True;
...
procedure TCustomShellListView.SetRoot(const Value: TRoot2005);
begin
...
procedure TCustomShellListView.SetTreeView(Value: TCustomShellTreeView2005);
begin
  if Value = FTreeView then Exit;
  if Value <> nil then
  begin
...
procedure TCustomShellListView.SetComboBox(Value: TCustomShellComboBox2005);
begin
  if Value = FComboBox then Exit;
  if Value <> nil then
  begin
