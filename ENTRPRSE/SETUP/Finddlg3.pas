...
uses
  ...
  SetupBas, ExtCtrls, StdCtrls, FileCtrl, FilCtl95, ComCtrls,
  ShellCtrls2005;
...
type
  TfrmFindDlg = class(TSetupTemplate)
    ...
    Label2: TLabel;
    lblSearch: TLabel;
    ShellComboBox20051: TShellComboBox2005;
...
begin
  ...
  If DirectoryExists(ShellComboBox20051.Path) Then
  Begin
    ...
    Try
      ...
      SearchDir (ShellComboBox20051.Path);
      lblSearch.Caption := '';
      Label2.Caption := '';
    ...
    End;
  End; // If DirectoryExists(ShellComboBox20051.Path)
end;
...
Begin { SearchDir }
  ...
  If FileExists(DirPath + 'exchqss.dat') And (Not FileExists(DirPath + 'iao.dat')) Then Begin
    GotSys := False;
    Case FindMode Of
      1..3 : Begin { Find Exchequer }
