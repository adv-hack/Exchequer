...
Begin
  ...
  With JRec do
    Case Mode of
      ...
      99  :  Ok2DelJob:=((Not CheckExsists(JobCode,JobF,JobCatK))
...
Begin
  ...
  Begin
    ...
    Begin
      ...
      TagCost:=TagCost+(Currency_ConvFT(Round_Up(Qty*Cost,2),ActCurr,InCurr,UseCoDayRate)*DedCnst);

      TagCharge:=TagCharge+(Currency_ConvFT(Charge,CurrCharge,InCurr,UseCoDayRate)*DedCnst);
