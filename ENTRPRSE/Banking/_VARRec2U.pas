        ...
        {$IFDEF LTE01}
          ...
          {SubType = '1'}
              ...
              {210}   brIntRef     :  LongInt;      { Internal Reference (Relational link to lines }
                      ...
                      brGLCode     :  longint;      {GL code of bank account}

                      brStatFolio  :  longint;      {Folio of related statement}

                      brReconDate  :  LongDate;     {Reconciliation date}

                      brReconRef   :  String[20];   {Reconcilitation Reference}

                      brInitSeq    :  Byte;         {Initial sequence shown in Recon form list}

              {213}   Spare        :  Array[1..514] of Byte;
          ...
          {SubType = '2'}
              ...
              {131}   brMatchRef   :  String[16];   {  OurRef of linked doc }
          ...
          {SubType = '3'}
              ...
              //PR Added brSortCode, brAccountCode, brBankRef, brUserID
          ...
          {SubType = '4'}
              ...
              {115}   ebStatRef    :  String[20];   {  Bank Statement ref }
