...
Const
  ...
  DefaultPayFileName = 'Acc_Pay.dat';
  DefaultRecFileName = 'Acc_DDeb.dat';
...
Begin
  ...
  if (WinID = BacsHook) then
    HandleBatchHooks(EventData, HandlerID, exAcc, ftaBoth, DefaultPayFilename,
                     DefaultRecFileName);
