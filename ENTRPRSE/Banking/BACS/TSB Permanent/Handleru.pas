...
Const
  ...
  DefaultPayFileName = 'TSB_EFT.DAT';
  DefaultRecFileName = 'TSB_EFT.DAT';
...
Begin
  ...
  if (WinID = BacsHook) then
    HandleBatchHooks(EventData, HandlerID, exTSBPerm, ftaBoth, DefaultPayFilename,
                     DefaultRecFileName);
