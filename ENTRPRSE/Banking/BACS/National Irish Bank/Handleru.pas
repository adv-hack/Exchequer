...
Const
  ...
  DefaultPayFileName = 'EFTFL.DAT';
  DefaultRecFileName = 'EFTFL.DAT';
...
Begin
  ...
  if (WinID = BacsHook) then
    HandleBatchHooks(EventData, HandlerID, exNIB, ftaBoth, DefaultPayFilename,
                     DefaultRecFileName);
