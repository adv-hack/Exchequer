unit TaxRegionCustomFields;

interface

  function AddTaxRegionCustomFields(var ErrString : string) : Integer;
...
// Copied from AddressCustomFields.pas
...
var
  ...
  Begin // AddCustomField
    ...
    Begin
      ...
      // Check for existing record - the MS SQL version incorrectly allows duplicates so we need to manually check
...
begin
  ...
  Try
    ...
    // Tax regions ------------------------------------------
    // Fields IDs are (Category x 1000) + index.
    AddCustomField (46001, 'User Def 1');
    AddCustomField (46002, 'User Def 2');
  Finally
