...
Const
  {$IFDEF EXSQL}
     ...
     ERROR - This version does not support SQL - Use X:\Entrprse\MultComp\oBtrieveFile.Pas instead
...
Begin // OpenFile
  ...
  Begin
    ...
    Begin
      ...
      If CreateIfMissing And (Not FileExists (FFilePath)) Then
      Begin
        // Create the data file
        Result := Make_FileCId(FFileVar, FFilePath, FDataFile^, FDataFileLen, FClientId);
      End; // If CreateIfMissing And (Not FileExists (FFilePath))
