...
const
  {$IFDEF TRIALRUN}
  ApVersionStr = 'v4.03 Trial';
  {$ELSE}
  ApVersionStr = 'v4.03';
  {$ENDIF}
  {$IFDEF Apax}
    {$IFDEF APAXTRIALRUN}
    ApaxVersionStr = 'v1.10 Demo';
    {$ELSE}
    ApaxVersionStr = 'v1.10';
    {$ENDIF}
  {$ENDIF}
...
{$IFDEF Apax}                                                          
var
  ApAmbientUserMode : WordBool;
function ApCheckDesigning(AComponent : TComponent) : Boolean;
{$ENDIF}
...
{$IFDEF Apax}                                                          
function ApCheckDesigning(AComponent : TComponent) : Boolean;          
    {-Return true if component or OLE container is in design mode}     
begin                                                                  
  Result := not Boolean(ApAmbientUserMode);                            
end;                                                                   
{$ENDIF}                                                               
