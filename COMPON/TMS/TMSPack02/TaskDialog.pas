...
function TAdvTaskDialog.CreateButton(AOwner: TComponent): TWinControl;
begin
...
procedure TAdvTaskDialog.SetCustomIcon(const Value: TIcon);
begin
...
procedure TAdvTaskDialog.SetButtonCancel(aButton: TWinControl; Value: Boolean);
begin
...
procedure TAdvTaskDialog.SetButtonDefault(aButton: TWinControl; Value: Boolean);
begin
  if not Assigned(aButton) or not (aButton is TButton) then
    Exit;
...
procedure TAdvTaskDialog.SetButtonModalResult(aButton: TWinControl; Value: Integer);
begin
  if not Assigned(aButton) or not (aButton is TButton) then
    Exit;
...
function TAdvTaskDialog.GetButtonModalResult(
...
procedure TAdvTaskDialog.SetButtonCaption(aButton: TWinControl;
  Value: TCaption);
begin
  if not Assigned(aButton) or not (aButton is TButton) then
    Exit;
