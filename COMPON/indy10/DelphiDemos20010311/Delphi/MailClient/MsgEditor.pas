...
uses
   ...
   IdMessage, IdComponent, IdTCPConnection, IdTCPClient, IdMessageClient, idtext,
   IdSMTP, ImgList, IdExplicitTLSClientServerBase, IdSMTPBase, idattachment, idattachmentfile;
