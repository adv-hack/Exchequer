...
type
  ...
  PPSPropProblemArray = ^PSPropProblemArray;
  ...
  IMAPIProp =
    ...
    [strIID_IMAPIProp]
      ...
      function SetProps (cValues : ULONG; lpPropArray : PSPropValue; 
        lppProblems : PPSPropProblemArray) : HResult; stdcall;
  ...
  IMAPIContainer =
    ...
    [strIID_IMAPIContainer]
      ...
      function OpenEntry (cbEntryID : ULONG; lpEntryID : PENTRYID; const lpInterface : TIID; 
        ulFlags : ULONG; var lpulObjType : ULONG; lppUnk : PUnknown) : HResult; stdcall;
...
type
  ...
  IMAPIFolder =
    interface(IMAPIContainer)
    [strIID_IMAPIFolder]
      function CreateMessage (const lpInterface : PIID; ulFlags : ULONG;
  ...
  IMsgStore =
    ...
    [strIID_IMsgStore]  
      ...
      function GetReceiveFolder (lpszMessageClass : PChar; ulFlags : ULONG; 
        ...
        lppszExplicitClass : PPChar) : HResult; stdcall;
  ...
  IMessage =
    ...
    [strIID_IMessage]
      ...
      function OpenAttach (ulAttachmentNum : ULONG; const lpInterface : PIID;
