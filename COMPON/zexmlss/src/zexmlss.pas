...
const
   _PointToMM:    Double = 0.3528;  // 1 типографский пункт = 0.3528 мм
...
type
  ...
  protected
    ...
    function  GetSizePoint(): Double;
    procedure SetSizePoint(Value: Double);
    function  GetSizeMM(): Double;
    procedure SetSizeMM(Value: Double);
  ...
  public
    ...
    property Width: Double read GetSizePoint write SetSizePoint;
    property WidthMM: Double read GetSizeMM write SetSizeMM;
  ...
  public
    ...
    property Height: Double read GetSizePoint write SetSizePoint;
    property HeightMM: Double read GetSizeMM write SetSizeMM;
...
// introduced don't know when in FPC
  ...
  protected
    procedure SetColWidth(num: integer; const Value: Double); virtual;
    function  GetColWidth(num: integer): Double; virtual;
    procedure SetRowHeight(num: integer; const Value: Double); virtual;
    function  GetRowHeight(num: integer): Double; virtual;
    procedure SetDefaultColWidth(const Value: Double); virtual;
    procedure SetDefaultRowHeight(const Value: Double); virtual;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
    procedure Clear(); virtual;
    property ColWidths[num: integer]: Double read GetColWidth write SetColWidth;
    ...
    property RowHeights[num: integer]: Double read GetRowHeight write SetRowHeight;
    property DefaultColWidth: Double read FDefaultColwidth write SetDefaultColWidth;// default 48;
    property DefaultRowHeight: Double read FDefaultRowHeight write SetDefaultRowHeight;// default 12.75;
  ...
  private
    ...
    FCreated     : TdateTime;
    FCompany     : string;
    FVersion     : string; // - should be integer by Spec but hardcoded float in Double MS Office apps
    FWindowHeight: word;
    FWindowWidth : word;
    FWindowTopX  : integer;
    FWindowTopY  : integer;
  ...
  private
    ...
    FStyles: TZStyles;
    FHorPixelSize: Double;
    FVertPixelSize: Double;
    FDefaultSheetOptions: TZSheetOptions;
    procedure SetHorPixelSize(Value: Double);
    procedure SetVertPixelSize(Value: Double);
  ...
  published
    ...
    property HorPixelSize: Double read FHorPixelSize write SetHorPixelSize;  //размер пикселя по горизонтали
    property VertPixelSize: Double read FVertPixelSize write SetVertPixelSize;  //размер пикселя по вертикали
  end;
...
function PixelToPoint(inPixel: integer; PixelSizeMM: double = 0.265): double;

//Перевести типографский пункт (point) в пиксели
function PointToPixel(inPoint: double; PixelSizeMM: double = 0.265): integer;

//Перевести типографский пункт (point) в мм
function PointToMM(inPoint: double): double;

//Перевести мм в типографский пункт (point)
function MMToPoint(inMM: double): double;
...
//      PixelSizeMM: Double = 0.265 - размер пикселя
function PixelToPoint(inPixel: integer; PixelSizeMM: Double = 0.265): Double;
begin
...
function  TZRowColOptions.GetSizePoint(): Double;
begin
  result := FSize;
end;

procedure TZRowColOptions.SetSizePoint(Value: Double);
begin
  if Value < 0 then  exit;
  FSize := Value;
end;

function  TZRowColOptions.GetSizeMM(): Double;
begin
  result := PointToMM(FSize);
end;

procedure TZRowColOptions.SetSizeMM(Value: Double);
begin
...
procedure TZSheet.SetColWidth(num: integer; const Value: Double);
begin
...
function TZSheet.GetColWidth(num: integer): Double;
begin
  result := 0;
...
procedure TZSheet.SetRowHeight(num: integer; const Value: Double);
begin
...
function TZSheet.GetRowHeight(num: integer): Double;
begin
  result := 0;
...
procedure TZSheet.SetDefaultColWidth(const Value: Double);
begin
  if Value >= 0 then
...
procedure TZSheet.SetDefaultRowHeight(const Value: Double);
begin
  if Value >= 0 then
...
procedure TZEXMLSS.SetHorPixelSize(Value: Double);
begin
  if Value > 0 then
    FHorPixelSize := Value;
end;

procedure TZEXMLSS.SetVertPixelSize(Value: Double);
begin
  if Value > 0 then
