...
uses
  ...
  DesignIntf, DesignEditors, StdCtrls, ShellCtrls2005;
...
type
  ...
  TRootProperty2005 = class(TStringProperty)
  public
    procedure Edit; override;
    function GetAttributes: TPropertyAttributes; override;
  end;

  TRootEditor2005 = class(TComponentEditor)
  public
...
procedure TRootProperty2005.Edit;
begin
  SetStrValue(RootPathEditor(GetStrValue));
end;

function TRootProperty2005.GetAttributes: TPropertyAttributes;
begin
  Result := [paDialog];
end;
...
procedure TRootEditor2005.ExecuteVerb(Index: Integer);
...
function TRootEditor2005.GetVerb(Index: Integer): String;
begin
  case Index of
  0 : Result := SEditRoot;
  end;
...
function TRootEditor2005.GetVerbCount: Integer;
begin
  Result := 1;
end;
