    ...
    const CTypeKindNames : array [TTypeKind] of PAnsiChar =
      ('Unknown', 'Integer', 'Char', 'Enum', 'Float',
       ...
       {$ifdef UNICODE},
         'UnicodeString'
       {$endif}
       {$ifndef ver120}{$ifndef ver130}{$ifndef ver140}{$ifndef ver150}{$ifndef ver160}{$ifndef ver170}{$ifndef ver180}{$ifndef ver185}{$ifndef ver200},
    ...
    const CMethodKindNames : array [TMethodKind] of PAnsiChar =
      ('procedure', 'function', 'constructor', 'destructor',
       ...
       {$ifndef ver120}{$ifndef ver130}{$ifndef ver140}{$ifndef ver150}{$ifndef ver160}
         'class constructor',
         {$ifndef ver170}{$ifndef ver180}{$ifndef ver185}{$ifndef ver200}
           'class destructor',
