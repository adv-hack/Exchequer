...
// File generated on 09/05/2001 10:06:29 from Type Library described below.

// ************************************************************************ //
// Type Lib: X:\EBUS2\XMLTRANS\XmlWrite.tlb (1)
// IID\LCID: {6771452B-98B8-4DF4-892B-A1F57BDEADB8}\0
// Helpfile: 
// DepndLst: 
...
const
  ...
  XmlWriteMajorVersion = 1;
  XmlWriteMinorVersion = 0;

  LIBID_XmlWrite: TGUID = '{6771452B-98B8-4DF4-892B-A1F57BDEADB8}';

  IID_IXmlTransaction: TGUID = '{7EA0987C-4A6F-4A3F-BC05-DD9795F437A1}';
  IID_IXmlWriter: TGUID = '{3FCDC51F-DBA1-4C0F-AFE7-894AE90012EB}';
  IID_INarrative: TGUID = '{821E3B23-D2CD-4F3B-A5CD-D814EED8CE87}';
  IID_ITransactionLine: TGUID = '{C977929F-5508-4BDF-8E44-8A13BC5CB216}';
  IID_ITransactionLines: TGUID = '{3761A5F8-8461-45D5-A65B-6CE65D4A4BAF}';
  IID_IAddress: TGUID = '{37485C57-34BF-4214-B358-D8D9115F68EE}';
...
// GUID:      {7EA0987C-4A6F-4A3F-BC05-DD9795F437A1}
// *********************************************************************//
  IXmlTransaction = interface(IDispatch)
    ['{7EA0987C-4A6F-4A3F-BC05-DD9795F437A1}']
...
// *********************************************************************//
  IXmlWriter = interface(IXmlTransaction)
