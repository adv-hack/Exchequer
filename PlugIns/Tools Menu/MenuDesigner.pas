...
uses
  ...
  , uSettingsSQL, SystemSetup, DataModule
{$IFNDEF REMOVE_VRW}
  ,PickReport
{$ENDIF}
  ;
...
//
// MH  08/10/2014  v7.0.12.147  Rebadged to v7.0.12
//
// MH 19/09/07    v6.00.136     Updated tree graphics in menu designer
//
// Mh 17/09/07    v6.00.135     Removed code for manipulating WRW/VRW menu options
//
...
implementation
uses
  Registry, APIUtil, ToolProc, StrUtil, EntMenuU, BTConst, BTUtil, FileUtil, EntLicence
{$IFNDEF REMOVE_VRW}
  , MenuManager
{$ENDIF}
  ;
...
var
  iLevel : integer;
  slNonIAOOptions : TStringList;

  procedure InitialiseNonIAOOptions;
  begin{InitialiseNonIAOOptions}
    slNonIAOOptions := TStringList.Create;
    slNonIAOOptions.Add('SRN1');
    slNonIAOOptions.Add('PRN1');
    slNonIAOOptions.Add('WOP1');
    slNonIAOOptions.Add('TeleSales1');
    slNonIAOOptions.Add('JobCosting2');
    slNonIAOOptions.Add('NominalLedger2');
    slNonIAOOptions.Add('STree1');
    slNonIAOOptions.Add('MLoc1');
    slNonIAOOptions.Add('JobCosting1');
    slNonIAOOptions.Add('Empl1');
    slNonIAOOptions.Add('JAnal1');
    slNonIAOOptions.Add('QFSerialF');
    slNonIAOOptions.Add('QFBinF');
    slNonIAOOptions.Add('QFJobF');
    slNonIAOOptions.Add('N8');
    slNonIAOOptions.Add('ObjectDrill1');
    slNonIAOOptions.Add('ObjectCC1');
    slNonIAOOptions.Add('ObjectStk1');
    slNonIAOOptions.Add('ObjPrice1');
    slNonIAOOptions.Add('GLRec2');
    slNonIAOOptions.Add('N33');
    slNonIAOOptions.Add('N27');
    slNonIAOOptions.Add('PRAccrual1');
    slNonIAOOptions.Add('SRAccrual1');
    slNonIAOOptions.Add('CISEDI1');
    slNonIAOOptions.Add('CISEDI2');
    slNonIAOOptions.Add('CISEDI3');
    slNonIAOOptions.Add('N37');
    slNonIAOOptions.Add('Commitment1');
    slNonIAOOptions.Add('RemoveCommit');
    slNonIAOOptions.Add('N38');
    slNonIAOOptions.Add('CCDepRep1');
    slNonIAOOptions.Add('ValRep2');
    slNonIAOOptions.Add('ValRep3');
    slNonIAOOptions.Add('N23');
    slNonIAOOptions.Add('Bins1');
    slNonIAOOptions.Add('StockbyBin1');
    slNonIAOOptions.Add('StockHistorybyBin1');
    slNonIAOOptions.Add('N28');
    slNonIAOOptions.Add('Returns1');
    slNonIAOOptions.Add('SalesRetAnal1');
    slNonIAOOptions.Add('PurchRetAnal1');
    slNonIAOOptions.Add('JobCostR1');
    slNonIAOOptions.Add('JCRBS1');
    slNonIAOOptions.Add('JCEL1');
    slNonIAOOptions.Add('JCEL2');
    slNonIAOOptions.Add('JCEL3');
    slNonIAOOptions.Add('Suby1');
    slNonIAOOptions.Add('Suby2');
    slNonIAOOptions.Add('Suby3');
    slNonIAOOptions.Add('JCJH1');
    slNonIAOOptions.Add('JCCE1');
    slNonIAOOptions.Add('JCBA1');
    slNonIAOOptions.Add('JCAA1');
    slNonIAOOptions.Add('JCWIP1');
    slNonIAOOptions.Add('JCBR1');
    slNonIAOOptions.Add('N12');
    slNonIAOOptions.Add('CISRep1');
    slNonIAOOptions.Add('CISRet1');
    slNonIAOOptions.Add('RCTRet1');
    slNonIAOOptions.Add('N13');
    slNonIAOOptions.Add('AppsRep1');
    slNonIAOOptions.Add('AppsRep2');
    slNonIAOOptions.Add('AppsRep4');
    slNonIAOOptions.Add('AppsRep20');
    slNonIAOOptions.Add('AppsRep21');
    slNonIAOOptions.Add('N15');
    slNonIAOOptions.Add('WOPRep1');
    slNonIAOOptions.Add('WOPF1');
    slNonIAOOptions.Add('WOPF3');
    slNonIAOOptions.Add('WOPF2');
    slNonIAOOptions.Add('KitBKRep2');
    slNonIAOOptions.Add('WOPWIP1');
    slNonIAOOptions.Add('RWSepBar');
    slNonIAOOptions.Add('RWriter');
    slNonIAOOptions.Add('RetReasons1');
    slNonIAOOptions.Add('CIS1');
    slNonIAOOptions.Add('DelAudit1');
    slNonIAOOptions.Add('Purge1');
    slNonIAOOptions.Add('Purge2');
    slNonIAOOptions.Add('N7');
  end;{InitialiseNonIAOOptions}
  ...
  begin{LoadNodesFrom}
    ...
    begin
      bAdd := TRUE;
      if ((length(MenuItems[iPos].Name) > 3) and (UpperCase(Copy(MenuItems[iPos].Name,1,3)) = 'XXX'))
      then begin
        // do not add the node  as it is an Enterprise Debug Option
      end else
      begin
        if (EnterpriseLicence.elProductType in [ptLITECust, ptLITEAcct])
        and (slNonIAOOptions.IndexOf(MenuItems[iPos].Name) <> -1)
        then begin
          // do not add the node  as it is an Enterprise Only Option, and we are running as IAO
        end else
        begin
    ...
    //       MenuItemInfo.Position := iPos + 1;
            ...
            begin
              ...
              // do not add items that are only for another company
              //v6.30.142
//              if (MenuItemInfo.MenuItemRec.miAvailability = AV_SpecificCompany)
//              and (Trim(MenuItemInfo.MenuItemRec.miCompany) <> Trim(CurrentCompanyRec.Code))
              if (MenuItemInfo.MenuItemRec.miAvailability = AV_SpecificCompany)
              and (Trim(MenuItemInfo.MenuItemRec.miCompany) <> Trim(asCompanyCode))
      ...
      //         MenuItemInfo.ParentComponentName := TMenuItemInfo(ParentItem.Data).MenuItemRec.miComponentName;
            ...
            begin
              // as we are not adding the item, we may as well destroy the object we were going to add to it
              MenuItemInfo.Free;
            end;{if}
          end;{if}

          if bAdd then LoadNodesFrom(MenuItems[iPos], NewItem);
        end;{if}
      end;{if}
    end;{for}
  end;{LoadNodesFrom}
...
begin
  ...
  InitialiseNonIAOOptions;
  LoadNodesFrom(EnterpriseMenu.Items, nil);
  slNonIAOOptions.Clear;
  slNonIAOOptions.Free;
...
begin
  ...
  {$IFNDEF REMOVE_VRW}
    and (RWMenuManager.mmVRWAvailable)
  {$ENDIF}
  ;
...
// MH 04/03/2015: Removed version from caption
//  if EnterpriseLicence.elProductType in [ptLITECust, ptLITEAcct] then
//  begin
//    // IAO
//    Caption := 'Menu Designer v1.00.' + BUILD_NUMBER;
//  end else
//  begin
//    // Exchequer
//    Caption := 'Menu Designer v7.0.12.' + BUILD_NUMBER;
//  end;
  ...
  //v6.30.142
//  rbThisCompany.Caption := 'Only available to this company (' + Trim(CurrentCompanyRec.Code) + ')';
  rbThisCompany.Caption := 'Only available to this company (' + Trim(asCompanyCode) + ')';

  LoadAllSettings;
  panDetails.Visible := FALSE;

{$IFDEF REMOVE_VRW}
  Caption := Caption + ' !!! DEBUG VERSION - DO NOT DISTRIBUTE !!!';
{$ENDIF}
end;
...
begin
  case MenuItemRec.miItemType of
    ...
    IT_Report : begin
      rbAllCompanies.Enabled := FALSE;
      rbThisCompany.Checked := TRUE;
      lTarget.Visible := TRUE;
      lTarget.Caption := 'Report Code';
      lStartIn.Visible := FALSE;
      lHelpText.Visible := TRUE;
      lCaption.Visible := TRUE;
...
begin
  ...
  begin
    ...
    // v6.30.142
//    Result.miCompany := CurrentCompanyRec.Code;
    Result.miCompany := asCompanyCode;
  end;{if}
...
//      ToolRec.DummyChar := IDX_DUMMY_CHAR;
    ...
    begin
      ...
      if CurrentMenuItemRec.miItemType = IT_Report
      then btnBrowseTargetClick(btnBrowseTarget);
    end;{if}
  end;{if}
end;
...
begin
  ...
  if (not (MenuItemRec.miItemType in [IT_SubMenu, IT_Report, IT_Separator]))
  ...
  // check filename exists
  if (MenuItemRec.miItemType = IT_Report) and (trim(MenuItemRec.miFilename) = '')
  then iError := 3;
  ...
  case iError of
    ...
    3 : begin
      MsgBox('You have entered an invalid Report Code. Please select a valid Code.'
      , mtError, [mbOK], mbOK, 'Validation Error');
      btnBrowseTargetClick(btnBrowseTarget);
    end;
  end;{case}
...
begin
  if CurrentMenuItemRec.miItemType = IT_Report then
  begin
  {$IFNDEF REMOVE_VRW}
    with TfrmPickReport.Create(self) do
    begin
      sPrevCode := trim(edPath.Text);
      if Showmodal = mrOK then
      begin
        if (tvReports.Selected <> nil) then
        begin
          edPath.Text := TReportInfo(tvReports.Selected.Data).ReportRec.sCode;
          if trim(edCaption.Text) = '' then edCaption.Text := TReportInfo(tvReports.Selected.Data).ReportRec.sName;
        end;{if}
      end;{if}
      Release;
    end;{with}
...
begin
  ...
  lblTargType.Caption := GetFileType(edPath.Text);
end;
...
procedure TfrmMenuDesigner.FormResize(Sender: TObject);
begin
  panButtons.Height := ClientHeight;
  panTree.Height := ClientHeight;
  panDetails.Height := ClientHeight;

  panTree.Width := ClientWidth - (panDetails.Width * ord(panDetails.visible)) - panButtons.Width;
  bvTree.Width := panTree.Width - 16;
  tvMenu.Width := bvTree.Width - 18;
  cbHide.Width := tvMenu.Width;

  bvTree.Height := ClientHeight - 16;
  bvDetails.Height := bvTree.Height;
  tvMenu.Height := bvTree.Height - 31;
  lbSpecificCompanies.Height := bvDetails.Height - 331;
  lbSpecificUsers.Height := lbSpecificCompanies.Height;

  cbHide.Top := ClientHeight - 28;

  panButtons.Left := ClientWidth - panButtons.Width;
  panDetails.Left := panTree.Width;
end;
