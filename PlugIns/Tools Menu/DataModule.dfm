object SQLDataModule: TSQLDataModule
  ...
  object qGetCompanyCode: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT CAST(SUBSTRING(Companycode1, 2, 6) AS VARCHAR) as Company' +
        'Code'
      'FROM Common.Company'
  ...
  object qGetCompanies: TADOQuery
    Connection = ADOConnection_Common
    Parameters = <>
    SQL.Strings = (
      'SELECT'
      ...
      'Company_code2 as CompanyName,'
        ...
        'CAST(SUBSTRING(Company_code3, 2, CAST(SUBSTRING(Company_code3, 1' +
        ', 1) AS INTEGER)) AS VARCHAR(255)) as CompanyPath'
      'FROM Common.Company'
      'WHERE (RecPFix = '#39'C'#39')'
      '')
    Left = 56
    Top = 128
  end
  object qTools: TADOQuery
    Connection = ADOConnection_Common
    Parameters = <>
    Left = 56
    Top = 184
  end
  object qTools2: TADOQuery
    Connection = ADOConnection_Common
    Parameters = <>
    Left = 56
    Top = 240
